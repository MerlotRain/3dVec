...
public:
    ...
    RVector get2D() const { return RVector(x, y); }
     ...
     * \nonscriptable
     */
    static void scaleList(QList<RVector> &list, double factor,
                          const RVector &center = nullVector);

    /**
     * \nonscriptable
     */
    static void scaleList(QList<RVector> &list, const RVector &factors,
                          const RVector &center = nullVector);
     ...
     * \nonscriptable
     */
    RVector copy() const { return *this; }
#endif

    static bool containsFuzzy(const QList<RVector> &vectors, const RVector &v,
                              double tol = RS::PointTolerance);
    static int findFirstFuzzy(const QList<RVector> &vectors, const RVector &v,
                              double tol = RS::PointTolerance);
    ...
    static QList<RVector> getUnion(const QList<RVector> &vectorsA,
                                   const QList<RVector> &vectorsB,
                                   double tol = RS::PointTolerance);
    static QList<RVector> getUnique(const QList<RVector> &vectors,
                                    double tol = RS::PointTolerance);
    ...
    static QList<RVector> getSortedByDistance(const QList<RVector> &list,
                                              const RVector &v);
    ...
    getSortedLeftRightTopBottom(const QList<RVector> &list);
    ...
    static QList<RVector> getSortedByAngle(const QList<RVector> &list,
...
CC2DCORE_EXPORT RVector operator*(double s, const RVector &v);
