...
public:
    ...
    static bool isSameDirection(double dir1, double dir2,
                                double tol = RS::AngleTolerance);
    static int absmod(int a, int b);

    static QString toFractionString(double v, int maxDenominator);
    static void toFraction(double v, int maxDenominator, int &number,
                           int &numerator, int &denominator);
    static void simplify(int numerator, int denominator, int &numeratorRes,
                         int &denominatorRes);
    ...
    static bool containsFuzzy(const QList<double> &values, double v,
