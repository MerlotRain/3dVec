...
public:
    ...
    RBox get2D() const { return RBox(c1.get2D(), c2.get2D()); }
    ...
    void growToIncludeBox(const RBox &other) { growToInclude(other); }
    /**
     * \nonscriptable
     */
    void growToInclude(const RVector &v);
    void growToIncludePoint(const RVector &v) { growToInclude(v); }
