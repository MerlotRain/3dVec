...
class CC2DCORE_EXPORT RLine : public RShape
{
public:
    RLine();
    ...
    virtual RShape::Type getShapeType() const { return Line; }

    virtual RLine *clone() const { return new RLine(*this); }
