...
public:
    ...
    virtual RS::EntityType getType() const { return RS::EntityTolerance; }
    virtual RShape *castToShape() { return NULL; }

    RVector getLocation() const { return location; }
    ...
    RVector getDirection() const { return direction; }
    ...
    int getRows() const { return divisions.length(); }
