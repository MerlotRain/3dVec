 ...
 * \ingroup entity
 */
class CC2DCORE_EXPORT RDimDiametricEntity : public RDimensionEntity
{
...
public:
    ...
    static RS::EntityType getRtti() { return RS::EntityDimDiametric; }
    ...
    virtual RDimDiametricData &getData() { return data; }

    void setData(RDimDiametricData &d) { data = d; }

    virtual const RDimDiametricData &getData() const { return data; }

    void setChordPoint(const RVector &p) { data.setChordPoint(p); }

    RVector getChordPoint() const { return data.getChordPoint(); }

    void setFarChordPoint(const RVector &p) { data.setFarChordPoint(p); }
