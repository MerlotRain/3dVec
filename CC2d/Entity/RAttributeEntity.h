...
public:
    ...
    static RS::EntityType getRtti() { return RS::EntityAttribute; }
    ...
    virtual RAttributeData &getData() { return data; }

    virtual const RAttributeData &getData() const { return data; }

    void setData(RAttributeData &d) { data = d; }
    ...
    void exportEntity(RExporter &e, bool preview,
