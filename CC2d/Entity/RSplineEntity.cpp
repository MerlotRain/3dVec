...
{
    RSplineEntity::PropertyCustom.generateId(RSplineEntity::getRtti(),
                                             RObject::PropertyCustom);
    RSplineEntity::PropertyHandle.generateId(RSplineEntity::getRtti(),
                                             RObject::PropertyHandle);
    RSplineEntity::PropertyProtected.generateId(RSplineEntity::getRtti(),
                                                RObject::PropertyProtected);
    RSplineEntity::PropertyWorkingSet.generateId(RSplineEntity::getRtti(),
                                                 RObject::PropertyWorkingSet);
    RSplineEntity::PropertyType.generateId(RSplineEntity::getRtti(),
                                           REntity::PropertyType);
    RSplineEntity::PropertyBlock.generateId(RSplineEntity::getRtti(),
                                            REntity::PropertyBlock);
    RSplineEntity::PropertyLayer.generateId(RSplineEntity::getRtti(),
                                            REntity::PropertyLayer);
    RSplineEntity::PropertyLinetype.generateId(RSplineEntity::getRtti(),
                                               REntity::PropertyLinetype);
    RSplineEntity::PropertyLinetypeScale.generateId(
            RSplineEntity::getRtti(), REntity::PropertyLinetypeScale);
    RSplineEntity::PropertyLineweight.generateId(RSplineEntity::getRtti(),
                                                 REntity::PropertyLineweight);
    RSplineEntity::PropertyColor.generateId(RSplineEntity::getRtti(),
                                            REntity::PropertyColor);
    RSplineEntity::PropertyDisplayedColor.generateId(
            RSplineEntity::getRtti(), REntity::PropertyDisplayedColor);
    RSplineEntity::PropertyDrawOrder.generateId(RSplineEntity::getRtti(),
                                                REntity::PropertyDrawOrder);

    RSplineEntity::PropertyPeriodic.generateId(
            RSplineEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Closed Periodic"));
    RSplineEntity::PropertyDegree.generateId(
            RSplineEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Degree"));

    RSplineEntity::PropertyControlPointNX.generateId(
            RSplineEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Control Point"),
            QT_TRANSLATE_NOOP("REntity", "X"), false,
            RPropertyAttributes::Geometry);
    RSplineEntity::PropertyControlPointNY.generateId(
            RSplineEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Control Point"),
            QT_TRANSLATE_NOOP("REntity", "Y"), false,
            RPropertyAttributes::Geometry);
    RSplineEntity::PropertyControlPointNZ.generateId(
            RSplineEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Control Point"),
            QT_TRANSLATE_NOOP("REntity", "Z"), false,
            RPropertyAttributes::Geometry);
    RSplineEntity::PropertyFitPointNX.generateId(
            RSplineEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Fit Point"),
            QT_TRANSLATE_NOOP("REntity", "X"), false,
            RPropertyAttributes::Geometry);
    RSplineEntity::PropertyFitPointNY.generateId(
            RSplineEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Fit Point"),
            QT_TRANSLATE_NOOP("REntity", "Y"), false,
            RPropertyAttributes::Geometry);
    RSplineEntity::PropertyFitPointNZ.generateId(
            RSplineEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Fit Point"),
            QT_TRANSLATE_NOOP("REntity", "Z"), false,
            RPropertyAttributes::Geometry);
    RSplineEntity::PropertyKnotN.generateId(
            RSplineEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Knot Vector"),
            QT_TRANSLATE_NOOP("REntity", "Knot"));

    RSplineEntity::PropertyLength.generateId(
            RSplineEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Length"));
    RSplineEntity::PropertyTotalLength.generateId(
            RSplineEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Total Length"));

    // TODO: tangent support:
    RSplineEntity::PropertyUseStartTangent.generateId(
            RSplineEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Use Start Tangent"));
    RSplineEntity::PropertyStartTangentX.generateId(
            RSplineEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Start Tangent"),
            QT_TRANSLATE_NOOP("REntity", "X"), false,
            RPropertyAttributes::Geometry);
    RSplineEntity::PropertyStartTangentY.generateId(
            RSplineEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Start Tangent"),
            QT_TRANSLATE_NOOP("REntity", "Y"), false,
            RPropertyAttributes::Geometry);
    RSplineEntity::PropertyStartTangentZ.generateId(
            RSplineEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Start Tangent"),
            QT_TRANSLATE_NOOP("REntity", "Z"), false,
            RPropertyAttributes::Geometry);
    RSplineEntity::PropertyUseEndTangent.generateId(
            RSplineEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Use End Tangent"));
    RSplineEntity::PropertyEndTangentX.generateId(
            RSplineEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "End Tangent"),
            QT_TRANSLATE_NOOP("REntity", "X"), false,
            RPropertyAttributes::Geometry);
    RSplineEntity::PropertyEndTangentY.generateId(
            RSplineEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "End Tangent"),
            QT_TRANSLATE_NOOP("REntity", "Y"), false,
            RPropertyAttributes::Geometry);
    RSplineEntity::PropertyEndTangentZ.generateId(
            RSplineEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "End Tangent"),
            QT_TRANSLATE_NOOP("REntity", "Z"), false,
            RPropertyAttributes::Geometry);
                                ...
                                RTransaction *transaction)
{
    ...
    ret = ret || RObject::setMemberX(data.controlPoints, value,
                                     PropertyControlPointNX == propertyTypeId);
    ret = ret || RObject::setMemberY(data.controlPoints, value,
                                     PropertyControlPointNY == propertyTypeId);
    ret = ret || RObject::setMemberZ(data.controlPoints, value,
                                     PropertyControlPointNZ == propertyTypeId);
    ret = ret || RObject::setMemberX(data.fitPoints, value,
                                     PropertyFitPointNX == propertyTypeId);
    ret = ret || RObject::setMemberY(data.fitPoints, value,
                                     PropertyFitPointNY == propertyTypeId);
    ret = ret || RObject::setMemberZ(data.fitPoints, value,
                                     PropertyFitPointNZ == propertyTypeId);
    ret = ret || RObject::setMember(data.knotVector, value,
                                    PropertyKnotN == propertyTypeId);
    ...
    // TODO: tangent support:
    ret = ret || RObject::setMember(data.tangentStart.valid, value,
                                    PropertyUseStartTangent == propertyTypeId);
    ret = ret || RObject::setMember(data.tangentStart.x, value,
                                    PropertyStartTangentX == propertyTypeId);
    ret = ret || RObject::setMember(data.tangentStart.y, value,
                                    PropertyStartTangentY == propertyTypeId);
    ret = ret || RObject::setMember(data.tangentStart.z, value,
                                    PropertyStartTangentZ == propertyTypeId);

    ret = ret || RObject::setMember(data.tangentEnd.valid, value,
                                    PropertyUseEndTangent == propertyTypeId);
    ret = ret || RObject::setMember(data.tangentEnd.x, value,
                                    PropertyEndTangentX == propertyTypeId);
    ret = ret || RObject::setMember(data.tangentEnd.y, value,
                                    PropertyEndTangentY == propertyTypeId);
    ret = ret || RObject::setMember(data.tangentEnd.z, value,
                                    PropertyEndTangentZ == propertyTypeId);
    ...
    if (PropertyDegree == propertyTypeId)
    {
        ...
        {
            ret = ret ||
                  RObject::setMember(data.degree, value.toString().toInt());
        }
    }
...
RSplineEntity::getProperty(RPropertyTypeId &propertyTypeId, bool humanReadable,
                           bool noAttributes, bool showOnRequest)
{
    ...
    if (!data.knotVector.isEmpty())
    {
        if (propertyTypeId == PropertyKnotN)
        {
            ...
            return qMakePair(
                    v, RPropertyAttributes(RPropertyAttributes::List |
...
void RSplineEntity::setShape(const RSpline &s) { data.setShape(s); }

void RSplineEntity::exportEntity(RExporter &e, bool preview,
