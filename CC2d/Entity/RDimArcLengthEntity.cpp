...
RDimArcLengthEntity::RDimArcLengthEntity(RDocument *document,
...
void RDimArcLengthEntity::init()
{
    ...
    RDimArcLengthEntity::PropertyProtected.generateId(
            RDimArcLengthEntity::getRtti(), RObject::PropertyProtected);
    RDimArcLengthEntity::PropertyWorkingSet.generateId(
            RDimArcLengthEntity::getRtti(), RObject::PropertyWorkingSet);
    RDimArcLengthEntity::PropertyType.generateId(RDimArcLengthEntity::getRtti(),
                                                 REntity::PropertyType);
    RDimArcLengthEntity::PropertyBlock.generateId(
            RDimArcLengthEntity::getRtti(), REntity::PropertyBlock);
    RDimArcLengthEntity::PropertyLayer.generateId(
            RDimArcLengthEntity::getRtti(), REntity::PropertyLayer);
    RDimArcLengthEntity::PropertyLinetype.generateId(
            RDimArcLengthEntity::getRtti(), REntity::PropertyLinetype);
    RDimArcLengthEntity::PropertyLinetypeScale.generateId(
            RDimArcLengthEntity::getRtti(), REntity::PropertyLinetypeScale);
    RDimArcLengthEntity::PropertyLineweight.generateId(
            RDimArcLengthEntity::getRtti(), REntity::PropertyLineweight);
    RDimArcLengthEntity::PropertyColor.generateId(
            RDimArcLengthEntity::getRtti(), REntity::PropertyColor);
    RDimArcLengthEntity::PropertyDisplayedColor.generateId(
            RDimArcLengthEntity::getRtti(), REntity::PropertyDisplayedColor);
    RDimArcLengthEntity::PropertyDrawOrder.generateId(
            RDimArcLengthEntity::getRtti(), REntity::PropertyDrawOrder);

    RDimArcLengthEntity::PropertyMiddleOfTextX.generateId(
            RDimArcLengthEntity::getRtti(),
            RDimensionEntity::PropertyMiddleOfTextX);
    RDimArcLengthEntity::PropertyMiddleOfTextY.generateId(
            RDimArcLengthEntity::getRtti(),
            RDimensionEntity::PropertyMiddleOfTextY);
    RDimArcLengthEntity::PropertyMiddleOfTextZ.generateId(
            RDimArcLengthEntity::getRtti(),
            RDimensionEntity::PropertyMiddleOfTextZ);

    RDimArcLengthEntity::PropertyText.generateId(
            RDimArcLengthEntity::getRtti(), RDimensionEntity::PropertyText);
    RDimArcLengthEntity::PropertyUpperTolerance.generateId(
            RDimArcLengthEntity::getRtti(),
            RDimensionEntity::PropertyUpperTolerance);
    RDimArcLengthEntity::PropertyLowerTolerance.generateId(
            RDimArcLengthEntity::getRtti(),
            RDimensionEntity::PropertyLowerTolerance);
    RDimArcLengthEntity::PropertyMeasuredValue.generateId(
            RDimArcLengthEntity::getRtti(),
            RDimensionEntity::PropertyMeasuredValue);

    RDimArcLengthEntity::PropertyDimscale.generateId(
            RDimArcLengthEntity::getRtti(), RDimensionEntity::PropertyDimscale);
    RDimArcLengthEntity::PropertyDimlfac.generateId(
            RDimArcLengthEntity::getRtti(), RDimensionEntity::PropertyDimlfac);
    RDimArcLengthEntity::PropertyDimtxt.generateId(
            RDimArcLengthEntity::getRtti(), RDimensionEntity::PropertyDimtxt);
    RDimArcLengthEntity::PropertyDimgap.generateId(
            RDimArcLengthEntity::getRtti(), RDimensionEntity::PropertyDimgap);
    RDimArcLengthEntity::PropertyDimasz.generateId(
            RDimArcLengthEntity::getRtti(), RDimensionEntity::PropertyDimasz);
    //RDimArcLengthEntity::PropertyDimdli.generateId(RDimArcLengthEntity::getRtti(), RDimensionEntity::PropertyDimdli);
    RDimArcLengthEntity::PropertyDimexe.generateId(
            RDimArcLengthEntity::getRtti(), RDimensionEntity::PropertyDimexe);
    RDimArcLengthEntity::PropertyDimexo.generateId(
            RDimArcLengthEntity::getRtti(), RDimensionEntity::PropertyDimexo);
    RDimArcLengthEntity::PropertyDimtad.generateId(
            RDimArcLengthEntity::getRtti(), RDimensionEntity::PropertyDimtad);
    RDimArcLengthEntity::PropertyDimtih.generateId(
            RDimArcLengthEntity::getRtti(), RDimensionEntity::PropertyDimtih);
    RDimArcLengthEntity::PropertyDimtsz.generateId(
            RDimArcLengthEntity::getRtti(), RDimensionEntity::PropertyDimtsz);
    RDimArcLengthEntity::PropertyDimlunit.generateId(
            RDimArcLengthEntity::getRtti(), RDimensionEntity::PropertyDimlunit);
    RDimArcLengthEntity::PropertyDimdec.generateId(
            RDimArcLengthEntity::getRtti(), RDimensionEntity::PropertyDimdec);
    RDimArcLengthEntity::PropertyDimdsep.generateId(
            RDimArcLengthEntity::getRtti(), RDimensionEntity::PropertyDimdsep);
    RDimArcLengthEntity::PropertyDimzin.generateId(
            RDimArcLengthEntity::getRtti(), RDimensionEntity::PropertyDimzin);
    ...
    RDimArcLengthEntity::PropertyArchTick.generateId(
            RDimArcLengthEntity::getRtti(), RDimensionEntity::PropertyArchTick);
    RDimArcLengthEntity::PropertyDimclrt.generateId(
            RDimArcLengthEntity::getRtti(), RDimensionEntity::PropertyDimclrt);
    ...
    RDimArcLengthEntity::PropertyDimBlockName.generateId(
            RDimArcLengthEntity::getRtti(),
            RDimensionEntity::PropertyDimBlockName);
    RDimArcLengthEntity::PropertyAutoTextPos.generateId(
            RDimArcLengthEntity::getRtti(),
            RDimensionEntity::PropertyAutoTextPos);
    RDimArcLengthEntity::PropertyFontName.generateId(
            RDimArcLengthEntity::getRtti(), RDimensionEntity::PropertyFontName);
    RDimArcLengthEntity::PropertyArrow1Flipped.generateId(
            RDimArcLengthEntity::getRtti(),
            RDimensionEntity::PropertyArrow1Flipped);
    RDimArcLengthEntity::PropertyArrow2Flipped.generateId(
            RDimArcLengthEntity::getRtti(),
            RDimensionEntity::PropertyArrow2Flipped);

    RDimArcLengthEntity::PropertyExtLineFix.generateId(
            RDimArcLengthEntity::getRtti(),
            RDimensionEntity::PropertyExtLineFix);
    RDimArcLengthEntity::PropertyExtLineFixLength.generateId(
            RDimArcLengthEntity::getRtti(),
    ...
    RDimArcLengthEntity::PropertyCenterX.generateId(
            RDimArcLengthEntity::getRtti(), RDimAngularEntity::PropertyCenterX);
    RDimArcLengthEntity::PropertyCenterY.generateId(
            RDimArcLengthEntity::getRtti(), RDimAngularEntity::PropertyCenterY);
    RDimArcLengthEntity::PropertyCenterZ.generateId(
            RDimArcLengthEntity::getRtti(), RDimAngularEntity::PropertyCenterZ);

    RDimArcLengthEntity::PropertyExtensionLine1EndX.generateId(
            RDimArcLengthEntity::getRtti(),
            RDimAngularEntity::PropertyExtensionLine1EndX);
    RDimArcLengthEntity::PropertyExtensionLine1EndY.generateId(
            RDimArcLengthEntity::getRtti(),
            RDimAngularEntity::PropertyExtensionLine1EndY);
    RDimArcLengthEntity::PropertyExtensionLine1EndZ.generateId(
            RDimArcLengthEntity::getRtti(),
    ...
    RDimArcLengthEntity::PropertyExtensionLine2EndX.generateId(
            RDimArcLengthEntity::getRtti(),
            RDimAngularEntity::PropertyExtensionLine2EndX);
    RDimArcLengthEntity::PropertyExtensionLine2EndY.generateId(
            RDimArcLengthEntity::getRtti(),
            RDimAngularEntity::PropertyExtensionLine2EndY);
    RDimArcLengthEntity::PropertyExtensionLine2EndZ.generateId(
            RDimArcLengthEntity::getRtti(),
    ...
    RDimArcLengthEntity::PropertyDimArcPositionX.generateId(
            RDimArcLengthEntity::getRtti(),
            RDimAngularEntity::PropertyDimArcPositionX);
    RDimArcLengthEntity::PropertyDimArcPositionY.generateId(
            RDimArcLengthEntity::getRtti(),
            RDimAngularEntity::PropertyDimArcPositionY);
    RDimArcLengthEntity::PropertyDimArcPositionZ.generateId(
            RDimArcLengthEntity::getRtti(),
            RDimAngularEntity::PropertyDimArcPositionZ);

    RDimArcLengthEntity::PropertyDimArcSymbolType.generateId(
            RDimArcLengthEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Arc Symbol Type"));
}
                                      ...
                                      RTransaction *transaction)
{
    ...
    ret = ret || RObject::setMember(data.center.x, value,
                                    PropertyCenterX == propertyTypeId);
    ret = ret || RObject::setMember(data.center.y, value,
                                    PropertyCenterY == propertyTypeId);
    ret = ret || RObject::setMember(data.center.z, value,
    ...
    ret = ret ||
          RObject::setMember(data.extensionLine2End.x, value,
                             PropertyExtensionLine2EndX == propertyTypeId);
    ret = ret ||
          RObject::setMember(data.extensionLine2End.y, value,
                             PropertyExtensionLine2EndY == propertyTypeId);
    ret = ret ||
          RObject::setMember(data.extensionLine2End.z, value,
                             PropertyExtensionLine2EndZ == propertyTypeId);

    ret = ret || RObject::setMember(data.definitionPoint.x, value,
                                    PropertyDimArcPositionX == propertyTypeId);
    ret = ret || RObject::setMember(data.definitionPoint.y, value,
                                    PropertyDimArcPositionY == propertyTypeId);
    ret = ret || RObject::setMember(data.definitionPoint.z, value,
                                    PropertyDimArcPositionZ == propertyTypeId);

    if (PropertyDimArcSymbolType == propertyTypeId)
    {
        ret = ret ||
              RObject::setMember(data.arcSymbolType, value.toInt(), true);
    }
...
RDimArcLengthEntity::getProperty(RPropertyTypeId &propertyTypeId,
                                 ...
                                 bool showOnRequest)
{
    ...
    {
        return qMakePair(QVariant(data.extensionLine2End.x),
                         RPropertyAttributes());
    }
    else if (propertyTypeId == PropertyExtensionLine2EndY)
    {
        return qMakePair(QVariant(data.extensionLine2End.y),
                         RPropertyAttributes());
    }
    else if (propertyTypeId == PropertyExtensionLine2EndZ)
    {
        return qMakePair(QVariant(data.extensionLine2End.z),
                         RPropertyAttributes());
    }
