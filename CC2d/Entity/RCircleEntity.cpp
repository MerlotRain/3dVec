...
void RCircleEntity::init()
{
    ...
    RCircleEntity::PropertyWorkingSet.generateId(RCircleEntity::getRtti(),
                                                 RObject::PropertyWorkingSet);
    RCircleEntity::PropertyType.generateId(RCircleEntity::getRtti(),
                                           REntity::PropertyType);
    RCircleEntity::PropertyBlock.generateId(RCircleEntity::getRtti(),
                                            REntity::PropertyBlock);
    RCircleEntity::PropertyLayer.generateId(RCircleEntity::getRtti(),
                                            REntity::PropertyLayer);
    RCircleEntity::PropertyLinetype.generateId(RCircleEntity::getRtti(),
                                               REntity::PropertyLinetype);
    RCircleEntity::PropertyLinetypeScale.generateId(
            RCircleEntity::getRtti(), REntity::PropertyLinetypeScale);
    RCircleEntity::PropertyLineweight.generateId(RCircleEntity::getRtti(),
                                                 REntity::PropertyLineweight);
    RCircleEntity::PropertyColor.generateId(RCircleEntity::getRtti(),
                                            REntity::PropertyColor);
    RCircleEntity::PropertyDisplayedColor.generateId(
            RCircleEntity::getRtti(), REntity::PropertyDisplayedColor);
    RCircleEntity::PropertyDrawOrder.generateId(RCircleEntity::getRtti(),
                                                REntity::PropertyDrawOrder);

    RCircleEntity::PropertyCenterX.generateId(
            RCircleEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Center"),
            QT_TRANSLATE_NOOP("REntity", "X"), false,
            RPropertyAttributes::Geometry);
    RCircleEntity::PropertyCenterY.generateId(
            RCircleEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Center"),
            QT_TRANSLATE_NOOP("REntity", "Y"), false,
            RPropertyAttributes::Geometry);
    RCircleEntity::PropertyCenterZ.generateId(
            RCircleEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Center"),
            QT_TRANSLATE_NOOP("REntity", "Z"), false,
            RPropertyAttributes::Geometry);
    RCircleEntity::PropertyRadius.generateId(
            RCircleEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Radius"), false,
            RPropertyAttributes::Geometry);

    RCircleEntity::PropertyDiameter.generateId(
            RCircleEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Diameter"));
    RCircleEntity::PropertyCircumference.generateId(
            RCircleEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Circumference"));
    RCircleEntity::PropertyArea.generateId(
            RCircleEntity::getRtti(), "", QT_TRANSLATE_NOOP("REntity", "Area"));
    RCircleEntity::PropertyTotalArea.generateId(
            RCircleEntity::getRtti(), "",
...
RCircleEntity::getProperty(RPropertyTypeId &propertyTypeId, bool humanReadable,
                           bool noAttributes, bool showOnRequest)
{
    ...
    {
        return qMakePair(QVariant(data.getCircumference()),
                         RPropertyAttributes(RPropertyAttributes::Redundant));
    }
    else if (propertyTypeId == PropertyArea)
    {
