...
public:
    ...
    static RS::EntityType getRtti() { return RS::EntityXLine; }
    ...
    virtual RXLineEntity *clone() const { return new RXLineEntity(*this); }
    ...
    void setBasePoint(const RVector &p) { data.setBasePoint(p); }

    RVector getBasePoint() const { return data.getBasePoint(); }

    void setSecondPoint(const RVector &p) { data.setSecondPoint(p); }

    RVector getSecondPoint() const { return data.getSecondPoint(); }
    ...
    RVector getDirectionVector() const { return data.getDirectionVector(); }

    double getAngle() const { return data.getAngle(); }

    bool hasFixedAngle() const { return data.hasFixedAngle(); }

    void setFixedAngle(bool on) { data.setFixedAngle(on); }
