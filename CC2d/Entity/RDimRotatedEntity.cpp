...
RDimRotatedEntity::RDimRotatedEntity(RDocument *document,
...
void RDimRotatedEntity::init()
{
    ...
    RDimRotatedEntity::PropertyProtected.generateId(
            RDimRotatedEntity::getRtti(), RObject::PropertyProtected);
    RDimRotatedEntity::PropertyWorkingSet.generateId(
            RDimRotatedEntity::getRtti(), RObject::PropertyWorkingSet);
    RDimRotatedEntity::PropertyType.generateId(RDimRotatedEntity::getRtti(),
                                               REntity::PropertyType);
    RDimRotatedEntity::PropertyBlock.generateId(RDimRotatedEntity::getRtti(),
                                                REntity::PropertyBlock);
    RDimRotatedEntity::PropertyLayer.generateId(RDimRotatedEntity::getRtti(),
                                                REntity::PropertyLayer);
    RDimRotatedEntity::PropertyLinetype.generateId(RDimRotatedEntity::getRtti(),
                                                   REntity::PropertyLinetype);
    RDimRotatedEntity::PropertyLinetypeScale.generateId(
            RDimRotatedEntity::getRtti(), REntity::PropertyLinetypeScale);
    RDimRotatedEntity::PropertyLineweight.generateId(
            RDimRotatedEntity::getRtti(), REntity::PropertyLineweight);
    RDimRotatedEntity::PropertyColor.generateId(RDimRotatedEntity::getRtti(),
                                                REntity::PropertyColor);
    RDimRotatedEntity::PropertyDisplayedColor.generateId(
            RDimRotatedEntity::getRtti(), REntity::PropertyDisplayedColor);
    RDimRotatedEntity::PropertyDrawOrder.generateId(
            RDimRotatedEntity::getRtti(), REntity::PropertyDrawOrder);

    RDimRotatedEntity::PropertyMiddleOfTextX.generateId(
            RDimRotatedEntity::getRtti(),
            RDimensionEntity::PropertyMiddleOfTextX);
    RDimRotatedEntity::PropertyMiddleOfTextY.generateId(
            RDimRotatedEntity::getRtti(),
            RDimensionEntity::PropertyMiddleOfTextY);
    RDimRotatedEntity::PropertyMiddleOfTextZ.generateId(
            RDimRotatedEntity::getRtti(),
            RDimensionEntity::PropertyMiddleOfTextZ);
    RDimRotatedEntity::PropertyText.generateId(RDimRotatedEntity::getRtti(),
                                               RDimensionEntity::PropertyText);
    RDimRotatedEntity::PropertyUpperTolerance.generateId(
            RDimRotatedEntity::getRtti(),
            RDimensionEntity::PropertyUpperTolerance);
    RDimRotatedEntity::PropertyLowerTolerance.generateId(
            RDimRotatedEntity::getRtti(),
            RDimensionEntity::PropertyLowerTolerance);
    RDimRotatedEntity::PropertyMeasuredValue.generateId(
            RDimRotatedEntity::getRtti(),
    ...
    RDimRotatedEntity::PropertyDimscale.generateId(
            RDimRotatedEntity::getRtti(), RDimensionEntity::PropertyDimscale);
    RDimRotatedEntity::PropertyDimlfac.generateId(
            RDimRotatedEntity::getRtti(), RDimensionEntity::PropertyDimlfac);
    RDimRotatedEntity::PropertyDimtxt.generateId(
            RDimRotatedEntity::getRtti(), RDimensionEntity::PropertyDimtxt);
    RDimRotatedEntity::PropertyDimgap.generateId(
            RDimRotatedEntity::getRtti(), RDimensionEntity::PropertyDimgap);
    RDimRotatedEntity::PropertyDimasz.generateId(
            RDimRotatedEntity::getRtti(), RDimensionEntity::PropertyDimasz);
    //RDimRotatedEntity::PropertyDimdli.generateId(RDimRotatedEntity::getRtti(), RDimensionEntity::PropertyDimdli);
    RDimRotatedEntity::PropertyDimexe.generateId(
            RDimRotatedEntity::getRtti(), RDimensionEntity::PropertyDimexe);
    RDimRotatedEntity::PropertyDimexo.generateId(
            RDimRotatedEntity::getRtti(), RDimensionEntity::PropertyDimexo);
    RDimRotatedEntity::PropertyDimtad.generateId(
            RDimRotatedEntity::getRtti(), RDimensionEntity::PropertyDimtad);
    RDimRotatedEntity::PropertyDimtih.generateId(
            RDimRotatedEntity::getRtti(), RDimensionEntity::PropertyDimtih);
    RDimRotatedEntity::PropertyDimtsz.generateId(
            RDimRotatedEntity::getRtti(), RDimensionEntity::PropertyDimtsz);
    RDimRotatedEntity::PropertyDimlunit.generateId(
            RDimRotatedEntity::getRtti(), RDimensionEntity::PropertyDimlunit);
    RDimRotatedEntity::PropertyDimdec.generateId(
            RDimRotatedEntity::getRtti(), RDimensionEntity::PropertyDimdec);
    RDimRotatedEntity::PropertyDimdsep.generateId(
            RDimRotatedEntity::getRtti(), RDimensionEntity::PropertyDimdsep);
    RDimRotatedEntity::PropertyDimzin.generateId(
            RDimRotatedEntity::getRtti(), RDimensionEntity::PropertyDimzin);
    ...
    RDimRotatedEntity::PropertyArchTick.generateId(
            RDimRotatedEntity::getRtti(), RDimensionEntity::PropertyArchTick);
    RDimRotatedEntity::PropertyDimclrt.generateId(
            RDimRotatedEntity::getRtti(), RDimensionEntity::PropertyDimclrt);
    ...
    RDimRotatedEntity::PropertyDimBlockName.generateId(
            RDimRotatedEntity::getRtti(),
            RDimensionEntity::PropertyDimBlockName);
    RDimRotatedEntity::PropertyAutoTextPos.generateId(
            RDimRotatedEntity::getRtti(),
            RDimensionEntity::PropertyAutoTextPos);
    RDimRotatedEntity::PropertyFontName.generateId(
            RDimRotatedEntity::getRtti(), RDimensionEntity::PropertyFontName);
    RDimRotatedEntity::PropertyArrow1Flipped.generateId(
            RDimRotatedEntity::getRtti(),
            RDimensionEntity::PropertyArrow1Flipped);
    RDimRotatedEntity::PropertyArrow2Flipped.generateId(
            RDimRotatedEntity::getRtti(),
            RDimensionEntity::PropertyArrow2Flipped);

    RDimRotatedEntity::PropertyExtLineFix.generateId(
            RDimRotatedEntity::getRtti(), RDimensionEntity::PropertyExtLineFix);
    RDimRotatedEntity::PropertyExtLineFixLength.generateId(
            RDimRotatedEntity::getRtti(),
            RDimensionEntity::PropertyExtLineFixLength);

    RDimRotatedEntity::PropertyDimensionLinePosX.generateId(
            RDimRotatedEntity::getRtti(),
            RDimLinearEntity::PropertyDimensionLinePosX);
    RDimRotatedEntity::PropertyDimensionLinePosY.generateId(
            RDimRotatedEntity::getRtti(),
            RDimLinearEntity::PropertyDimensionLinePosY);
    RDimRotatedEntity::PropertyDimensionLinePosZ.generateId(
            RDimRotatedEntity::getRtti(),
            RDimLinearEntity::PropertyDimensionLinePosZ);

    RDimRotatedEntity::PropertyExtensionPoint1X.generateId(
            RDimRotatedEntity::getRtti(),
            RDimLinearEntity::PropertyExtensionPoint1X);
    RDimRotatedEntity::PropertyExtensionPoint1Y.generateId(
            RDimRotatedEntity::getRtti(),
            RDimLinearEntity::PropertyExtensionPoint1Y);
    RDimRotatedEntity::PropertyExtensionPoint1Z.generateId(
            RDimRotatedEntity::getRtti(),
            RDimLinearEntity::PropertyExtensionPoint1Z);

    RDimRotatedEntity::PropertyExtensionPoint2X.generateId(
            RDimRotatedEntity::getRtti(),
            RDimLinearEntity::PropertyExtensionPoint2X);
    RDimRotatedEntity::PropertyExtensionPoint2Y.generateId(
            RDimRotatedEntity::getRtti(),
            RDimLinearEntity::PropertyExtensionPoint2Y);
    RDimRotatedEntity::PropertyExtensionPoint2Z.generateId(
            RDimRotatedEntity::getRtti(),
            RDimLinearEntity::PropertyExtensionPoint2Z);

    RDimRotatedEntity::PropertyAngle.generateId(
            RDimRotatedEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Dimension Angle"), false,
...
{
    bool ret =
            RDimLinearEntity::setProperty(propertyTypeId, value, transaction);
...
RDimRotatedEntity::getProperty(RPropertyTypeId &propertyTypeId,
                               ...
                               bool showOnRequest)
{
    ...
    QPair<QVariant, RPropertyAttributes> ret = RDimLinearEntity::getProperty(
            propertyTypeId, humanReadable, noAttributes, showOnRequest);
