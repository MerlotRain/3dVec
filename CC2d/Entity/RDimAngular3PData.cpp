...
RDimAngular3PData::RDimAngular3PData(RDocument *document,
...
RDimAngular3PData::RDimAngular3PData(const RDimensionData &dimData,
    ...
    : RDimAngularData(dimData), center(center),
      extensionLine1End(extensionLine1End), extensionLine2End(extensionLine2End)
{
}
...
QList<RRefPoint>
RDimAngular3PData::getReferencePoints(RS::ProjectionRenderingHint hint) const
{
...
bool RDimAngular3PData::scale(const RVector &scaleFactors,
                              const RVector &center)
{
