 ...
 * \ingroup entity
 */
class CC2DCORE_EXPORT RDimAngular2LEntity : public RDimAngularEntity
{
...
public:
    ...
    static RS::EntityType getRtti() { return RS::EntityDimAngular2L; }
    ...
    virtual RDimAngular2LData &getData() { return data; }

    void setData(RDimAngular2LData &d) { data = d; }

    virtual const RDimAngular2LData &getData() const { return data; }
