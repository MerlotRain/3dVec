 ...
 * \ingroup entity
 */
class CC2DCORE_EXPORT RDimRotatedEntity : public RDimLinearEntity
{
...
public:
    ...
    static RS::EntityType getRtti() { return RS::EntityDimRotated; }
    ...
    virtual RDimRotatedData &getData() { return data; }

    void setData(RDimRotatedData &d) { data = d; }

    virtual const RDimRotatedData &getData() const { return data; }

    void setExtensionPoint1(const RVector &p) { data.setExtensionPoint1(p); }

    RVector getExtensionPoint1() const { return data.getExtensionPoint1(); }

    void setExtensionPoint2(const RVector &p) { data.setExtensionPoint2(p); }

    RVector getExtensionPoint2() const { return data.getExtensionPoint2(); }

    void setRotation(double a) { data.setRotation(a); }
