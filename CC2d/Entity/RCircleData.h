...
public:
    ...
    virtual RS::EntityType getType() const { return RS::EntityCircle; }
    RCircle getCircle() { return *this; }

    bool isValid() const { return RCircle::isValid(); }
    ...
    virtual void setZ(double z) { RCircle::setZ(z); }
    virtual void to2D() { RCircle::to2D(); }
    ...
    virtual bool move(const RVector &offset) { return RCircle::move(offset); }
    ...
    virtual bool mirror(const RLine &axis) { return RCircle::mirror(axis); }
    ...
    RVector getCenter() const { return RCircle::getCenter(); }
    double getRadius() const { return RCircle::getRadius(); }
