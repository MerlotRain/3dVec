...
public:
    ...
    static RS::EntityType getRtti() { return RS::EntityPolyline; }
    ...
    virtual const RPolylineData &getData() const { return data; }

    RPolyline getPolylineShape() const { return data.getPolylineShape(); }
    ...
    int countVertices() const { return data.countVertices(); }
    ...
    void insertVertexAt(const RVector &vertex) { data.insertVertexAt(vertex); }

    RVector getVertexAt(int i) const { return data.getVertexAt(i); }

    void setVertexAt(int i, const RVector &v) { data.setVertexAt(i, v); }

    void removeLastVertex() { data.removeLastVertex(); }

    void removeVertex(int index) { data.removeVertex(index); }

    int countSegments() const { return data.countSegments(); }
    ...
    bool isArcSegmentAt(int i) const { return data.isArcSegmentAt(i); }

    bool hasArcSegments() const { return data.hasArcSegments(); }
    ...
    double getBulgeAt(int i) const { return data.getBulgeAt(i); }

    void setBulgeAt(int i, double b) { data.setBulgeAt(i, b); }
    ...
    void stripWidths() { data.stripWidths(); }

    void setMinimumWidth(double w) { data.setMinimumWidth(w); }

    void setGlobalWidth(double w) { data.setGlobalWidth(w); }

    void setStartWidthAt(int i, double w) { data.setStartWidthAt(i, w); }

    double getStartWidthAt(int i) const { return data.getStartWidthAt(i); }

    void setEndWidthAt(int i, double w) { data.setEndWidthAt(i, w); }

    double getEndWidthAt(int i) const { return data.getEndWidthAt(i); }

    bool hasWidths() const { return data.hasWidths(); }

    void setStartWidths(const QList<double> &sw) { data.setStartWidths(sw); }

    QList<double> getStartWidths() const { return data.getStartWidths(); }

    void setEndWidths(const QList<double> &ew) { data.setEndWidths(ew); }

    QList<double> getEndWidths() const { return data.getEndWidths(); }

    double getDirection1() const { return data.getDirection1(); }

    double getDirection2() const { return data.getDirection2(); }

    bool reverse() { return data.reverse(); }
    ...
    RVector getEndPoint() const { return data.getEndPoint(); }

    RVector getStartPoint() const { return data.getStartPoint(); }

    void relocateStartPoint(const RVector &p) { data.relocateStartPoint(p); }

    void setClosed(bool on) { data.setClosed(on); }

    bool isClosed() const { return data.isClosed(); }
    ...
    bool toLogicallyOpen() { return data.toLogicallyOpen(); }
    ...
    double getArea() const { return data.getArea(); }
    ...
    void setPolylineGen(bool on) { data.setPolylineGen(on); }
    bool getPolylineGen() const { return data.getPolylineGen(); }

    void setElevation(double v) { data.setElevation(v); }
    double getElevation() const { return data.getElevation(); }

    bool isFlat() const { return data.isFlat(); }
    ...
    bool trimEndPoint(double trimDist) { return data.trimEndPoint(trimDist); }
