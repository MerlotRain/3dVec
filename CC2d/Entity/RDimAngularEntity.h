 ...
 * \ingroup entity
 */
class CC2DCORE_EXPORT RDimAngularEntity : public RDimensionEntity
{
...
public:
    ...
    void setDimArcPosition(const RVector &p) { getData().setDimArcPosition(p); }

    RVector getDimArcPosition() const { return getData().getDimArcPosition(); }
