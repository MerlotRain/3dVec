...
public:
    ...
    virtual RS::EntityType getType() const { return RS::EntityRay; }
    RRay getRay() { return *this; }

    bool isValid() const { return RRay::isValid(); }
    ...
    virtual void setZ(double z) { RRay::setZ(z); }
    virtual void to2D() { RRay::to2D(); }
    ...
    virtual bool move(const RVector &offset) { return RRay::move(offset); }
    ...
    virtual bool mirror(const RLine &axis) { return RRay::mirror(axis); }
    ...
    RVector getBasePoint() const { return RRay::getBasePoint(); }
    RVector getDirectionVector() const { return RRay::getDirectionVector(); }
    double getAngle() const { return RRay::getAngle(); }

    bool hasFixedAngle() const { return fixedAngle; }

    void setFixedAngle(bool on) { fixedAngle = on; }

    bool reverse() { return RRay::reverse(); }
