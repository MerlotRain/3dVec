 ...
 * \ingroup entity
 */
class CC2DCORE_EXPORT RSolidEntity : public REntity
{
public:
...
public:
    ...
    static RS::EntityType getRtti() { return RS::EntitySolid; }
    ...
    virtual RSolidEntity *clone() const { return new RSolidEntity(*this); }
