...
RDimOrdinateEntity::RDimOrdinateEntity(RDocument *document,
...
void RDimOrdinateEntity::init()
{
    ...
    RDimOrdinateEntity::PropertyProtected.generateId(
            RDimOrdinateEntity::getRtti(), RObject::PropertyProtected);
    RDimOrdinateEntity::PropertyWorkingSet.generateId(
            RDimOrdinateEntity::getRtti(), RObject::PropertyWorkingSet);
    RDimOrdinateEntity::PropertyType.generateId(RDimOrdinateEntity::getRtti(),
                                                REntity::PropertyType);
    RDimOrdinateEntity::PropertyBlock.generateId(RDimOrdinateEntity::getRtti(),
                                                 REntity::PropertyBlock);
    RDimOrdinateEntity::PropertyLayer.generateId(RDimOrdinateEntity::getRtti(),
                                                 REntity::PropertyLayer);
    RDimOrdinateEntity::PropertyLinetype.generateId(
            RDimOrdinateEntity::getRtti(), REntity::PropertyLinetype);
    RDimOrdinateEntity::PropertyLinetypeScale.generateId(
            RDimOrdinateEntity::getRtti(), REntity::PropertyLinetypeScale);
    RDimOrdinateEntity::PropertyLineweight.generateId(
            RDimOrdinateEntity::getRtti(), REntity::PropertyLineweight);
    RDimOrdinateEntity::PropertyColor.generateId(RDimOrdinateEntity::getRtti(),
                                                 REntity::PropertyColor);
    RDimOrdinateEntity::PropertyDisplayedColor.generateId(
            RDimOrdinateEntity::getRtti(), REntity::PropertyDisplayedColor);
    RDimOrdinateEntity::PropertyDrawOrder.generateId(
            RDimOrdinateEntity::getRtti(), REntity::PropertyDrawOrder);

    RDimOrdinateEntity::PropertyMiddleOfTextX.generateId(
            RDimOrdinateEntity::getRtti(),
            RDimensionEntity::PropertyMiddleOfTextX);
    RDimOrdinateEntity::PropertyMiddleOfTextY.generateId(
            RDimOrdinateEntity::getRtti(),
            RDimensionEntity::PropertyMiddleOfTextY);
    RDimOrdinateEntity::PropertyMiddleOfTextZ.generateId(
            RDimOrdinateEntity::getRtti(),
            RDimensionEntity::PropertyMiddleOfTextZ);
    RDimOrdinateEntity::PropertyText.generateId(RDimOrdinateEntity::getRtti(),
                                                RDimensionEntity::PropertyText);
    RDimOrdinateEntity::PropertyUpperTolerance.generateId(
            RDimOrdinateEntity::getRtti(),
            RDimensionEntity::PropertyUpperTolerance);
    RDimOrdinateEntity::PropertyLowerTolerance.generateId(
            RDimOrdinateEntity::getRtti(),
            RDimensionEntity::PropertyLowerTolerance);
    RDimOrdinateEntity::PropertyMeasuredValue.generateId(
            RDimOrdinateEntity::getRtti(),
            RDimensionEntity::PropertyMeasuredValue);
    RDimOrdinateEntity::PropertyFontName.generateId(
            RDimOrdinateEntity::getRtti(), RDimensionEntity::PropertyFontName);
    RDimOrdinateEntity::PropertyTextRotation.generateId(
            RDimOrdinateEntity::getRtti(),
            RDimensionEntity::PropertyTextRotation);
    ...
    RDimOrdinateEntity::PropertyDimscale.generateId(
            RDimOrdinateEntity::getRtti(), RDimensionEntity::PropertyDimscale);
    RDimOrdinateEntity::PropertyDimlfac.generateId(
            RDimOrdinateEntity::getRtti(), RDimensionEntity::PropertyDimlfac);

    RDimOrdinateEntity::PropertyDimBlockName.generateId(
            RDimOrdinateEntity::getRtti(),
            RDimensionEntity::PropertyDimBlockName);

    RDimOrdinateEntity::PropertyOriginX.generateId(
            RDimOrdinateEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Origin"),
            QT_TRANSLATE_NOOP("REntity", "X"), false,
            RPropertyAttributes::Geometry);
    RDimOrdinateEntity::PropertyOriginY.generateId(
            RDimOrdinateEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Origin"),
            QT_TRANSLATE_NOOP("REntity", "Y"), false,
            RPropertyAttributes::Geometry);
    RDimOrdinateEntity::PropertyOriginZ.generateId(
            RDimOrdinateEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Origin"),
            QT_TRANSLATE_NOOP("REntity", "Z"), false,
            RPropertyAttributes::Geometry);

    RDimOrdinateEntity::PropertyOrdinate.generateId(
            RDimOrdinateEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Ordinate"), false,
            RPropertyAttributes::Geometry);
    RDimOrdinateEntity::PropertyDefiningPointX.generateId(
            RDimOrdinateEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Defining Point"),
            QT_TRANSLATE_NOOP("REntity", "X"), false,
            RPropertyAttributes::Geometry);
    RDimOrdinateEntity::PropertyDefiningPointY.generateId(
            RDimOrdinateEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Defining Point"),
            QT_TRANSLATE_NOOP("REntity", "Y"), false,
            RPropertyAttributes::Geometry);
    RDimOrdinateEntity::PropertyDefiningPointZ.generateId(
            RDimOrdinateEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Defining Point"),
            QT_TRANSLATE_NOOP("REntity", "Z"), false,
            RPropertyAttributes::Geometry);
    RDimOrdinateEntity::PropertyLeaderEndPointX.generateId(
            RDimOrdinateEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Leader End Point"),
            QT_TRANSLATE_NOOP("REntity", "X"), false,
            RPropertyAttributes::Geometry);
    RDimOrdinateEntity::PropertyLeaderEndPointY.generateId(
            RDimOrdinateEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Leader End Point"),
            QT_TRANSLATE_NOOP("REntity", "Y"), false,
            RPropertyAttributes::Geometry);
    RDimOrdinateEntity::PropertyLeaderEndPointZ.generateId(
            RDimOrdinateEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Leader End Point"),
            QT_TRANSLATE_NOOP("REntity", "Z"), false,
            RPropertyAttributes::Geometry);
                                     ...
                                     RTransaction *transaction)
{
    ...
    {
        if (RS::getMetaType(value) == QVariant::Bool)
        {
            ret = ret ||
                  RObject::setMember(getData().xType, value.toBool(), true);
            data.autoTextPos = true;
        }
        else if (RS::getMetaType(value) == QVariant::String)
        {
            ret = ret || RObject::setMember(getData().xType,
                                            value.toString() == "X", true);
            data.autoTextPos = true;
        }
    }
    ...
    ret = ret || RObject::setMember(data.definingPoint.x, value,
                                    PropertyDefiningPointX == propertyTypeId);
    ret = ret || RObject::setMember(data.definingPoint.y, value,
                                    PropertyDefiningPointY == propertyTypeId);
    ret = ret || RObject::setMember(data.definingPoint.z, value,
                                    PropertyDefiningPointZ == propertyTypeId);
    ret = ret || RObject::setMember(data.leaderEndPoint.x, value,
                                    PropertyLeaderEndPointX == propertyTypeId);
    ret = ret || RObject::setMember(data.leaderEndPoint.y, value,
                                    PropertyLeaderEndPointY == propertyTypeId);
    ret = ret || RObject::setMember(data.leaderEndPoint.z, value,
                                    PropertyLeaderEndPointZ == propertyTypeId);
...
RDimOrdinateEntity::getProperty(RPropertyTypeId &propertyTypeId,
                                ...
                                bool showOnRequest)
{
    if (propertyTypeId == PropertyOrdinate)
    {
        ...
        else { return qMakePair(QVariant(data.xType), RPropertyAttributes()); }
    }
    ...
    {
        return qMakePair(QVariant(data.leaderEndPoint.x),
                         RPropertyAttributes());
    }
    else if (propertyTypeId == PropertyLeaderEndPointY)
    {
        return qMakePair(QVariant(data.leaderEndPoint.y),
                         RPropertyAttributes());
    }
    else if (propertyTypeId == PropertyLeaderEndPointZ)
    {
        return qMakePair(QVariant(data.leaderEndPoint.z),
                         RPropertyAttributes());
    }
