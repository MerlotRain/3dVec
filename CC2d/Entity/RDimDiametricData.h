...
public:
    ...
    virtual RS::EntityType getType() const { return RS::EntityDimDiametric; }
    ...
    void setFarChordPoint(const RVector &p) { setDefinitionPoint(p); }

    RVector getFarChordPoint() const { return getDefinitionPoint(); }
