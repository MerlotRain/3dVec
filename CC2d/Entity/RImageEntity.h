 ...
 * \ingroup entity
 */
class CC2DCORE_EXPORT RImageEntity : public REntity
{
public:
...
public:
    ...
    static RS::EntityType getRtti() { return RS::EntityImage; }
    ...
    QString getFileName() const { return data.getFileName(); }

    void setFileName(const QString &fn) { data.setFileName(fn); }

    RVector getInsertionPoint() const { return data.getInsertionPoint(); }

    void setInsertionPoint(const RVector &ip) { data.setInsertionPoint(ip); }

    RVector getUVector() const { return data.getUVector(); }

    RVector getVVector() const { return data.getVVector(); }

    int getBrightness() const { return data.getBrightness(); }

    int getContrast() const { return data.getContrast(); }

    int getFade() const { return data.getFade(); }
    ...
    int getPixelWidth() const { return data.getPixelWidth(); }
