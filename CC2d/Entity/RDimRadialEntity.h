...
public:
    ...
    static RS::EntityType getRtti() { return RS::EntityDimRadial; }
    ...
    virtual RDimRadialData &getData() { return data; }

    void setData(RDimRadialData &d) { data = d; }

    virtual const RDimRadialData &getData() const { return data; }
