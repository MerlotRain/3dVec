 ...
 * \ingroup entity
 */
class CC2DCORE_EXPORT RDimOrdinateEntity : public RDimensionEntity
{
...
public:
    ...
    static RS::EntityType getRtti() { return RS::EntityDimOrdinate; }
    ...
    virtual RDimOrdinateData &getData() { return data; }

    void setData(RDimOrdinateData &d) { data = d; }

    virtual const RDimOrdinateData &getData() const { return data; }

    void setLeaderEndPoint(const RVector &p) { data.setLeaderEndPoint(p); }

    RVector getLeaderEndPoint() const { return data.getLeaderEndPoint(); }

    void setDefiningPoint(const RVector &p) { data.setDefiningPoint(p); }

    RVector getDefiningPoint() const { return data.getDefiningPoint(); }

    void setMeasuringXAxis() { data.setMeasuringXAxis(); }

    void setMeasuringYAxis() { data.setMeasuringYAxis(); }
