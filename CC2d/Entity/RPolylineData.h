...
public:
    ...
    virtual RS::EntityType getType() const { return RS::EntityPolyline; }

    bool isValid() const { return RPolyline::isValid(); }
    virtual QList<RVector>
    getEndPoints(const RBox &queryBox = RDEFAULT_RBOX,
                 QList<RObject::Id> *subEntityIds = NULL) const
    {
        return REntityData::getEndPoints(queryBox, subEntityIds);
    }
    virtual void setZ(double z) { RPolyline::setZ(z); }
    virtual void to2D() { RPolyline::to2D(); }
    virtual RBox getBoundingBox(bool ignoreEmpty = false) const
    {
        return REntityData::getBoundingBox();
    }
    virtual QList<RVector>
    getMiddlePoints(const RBox &queryBox = RDEFAULT_RBOX,
                    QList<RObject::Id> *subEntityIds = NULL) const
    {
        return REntityData::getMiddlePoints(queryBox, subEntityIds);
    }
    virtual QList<RVector>
    getCenterPoints(const RBox &queryBox = RDEFAULT_RBOX,
                    QList<RObject::Id> *subEntityIds = NULL) const
    {
        return REntityData::getCenterPoints(queryBox, subEntityIds);
    }
    virtual QList<RVector>
    getArcReferencePoints(const RBox &queryBox = RDEFAULT_RBOX) const
    {
        return REntityData::getArcReferencePoints(queryBox);
    }
    virtual QList<RVector>
    getPointsWithDistanceToEnd(double distance, int from = RS::FromAny,
                               const RBox &queryBox = RDEFAULT_RBOX,
                               QList<RObject::Id> *subEntityIds = NULL) const
    {
        return REntityData::getPointsWithDistanceToEnd(distance, from, queryBox,
                                                       subEntityIds);
    }
    virtual QList<RVector>
    getIntersectionPoints(const RShape &shape, bool limited = true,
                          const RBox &queryBox = RDEFAULT_RBOX,
                          bool ignoreComplex = true) const
    {
        return REntityData::getIntersectionPoints(shape, limited, queryBox,
                                                  ignoreComplex);
    }
    ...
    virtual bool move(const RVector &offset) { return RPolyline::move(offset); }
    ...
    virtual bool mirror(const RLine &axis) { return RPolyline::mirror(axis); }
    virtual bool mirror(const RVector &axis1, const RVector &axis2)
    {
        return REntityData::mirror(axis1, axis2);
    }
    virtual bool flipHorizontal() { return REntityData::flipHorizontal(); }
    virtual bool flipVertical() { return REntityData::flipVertical(); }
    ...
    virtual RShape *castToShape() { return this; }
                                 ...
                                 double strictRange = RMAXDOUBLE) const
    {
        if (!hasWidths())
        {
            return REntityData::getDistanceTo(point, limited, range, draft,
                                              strictRange);
        }

        // polylines with custom segment widths:
        double ret = RPolyline::getDistanceTo(point, limited, strictRange);
        if (ret > range) { return RNANDOUBLE; }
        return ret;
    }

    RPolyline getPolylineShape() const { return *this; }

    void clear() { RPolyline::clear(); }
    ...
    QList<RVector> getVertices() const { return RPolyline::getVertices(); }

    RVector getVertexAt(int i) const { return RPolyline::getVertexAt(i); }

    void setVertexAt(int i, const RVector &v) { RPolyline::setVertexAt(i, v); }
    ...
    void removeLastVertex() { RPolyline::removeLastVertex(); }

    void removeVertex(int index) { RPolyline::removeVertex(index); }

    int countSegments() const { return RPolyline::countSegments(); }
    ...
    double getBulgeAt(int i) const { return RPolyline::getBulgeAt(i); }

    void setBulgeAt(int i, double b) { RPolyline::setBulgeAt(i, b); }
    ...
    double getDirection1() const { return RPolyline::getDirection1(); }

    double getDirection2() const { return RPolyline::getDirection2(); }

    bool reverse() { return RPolyline::reverse(); }

    RVector getEndPoint() const { return RPolyline::getEndPoint(); }

    RVector getStartPoint() const { return RPolyline::getStartPoint(); }
    ...
    void setClosed(bool on) { RPolyline::setClosed(on); }

    bool isClosed() const { return RPolyline::isClosed(); }
    ...
    bool autoClose() { return RPolyline::toLogicallyClosed(); }
    ...
    bool toLogicallyOpen() { return RPolyline::toLogicallyOpen(); }
    ...
    void setGlobalWidth(double w) { RPolyline::setGlobalWidth(w); }

    void setStartWidthAt(int i, double w) { RPolyline::setStartWidthAt(i, w); }
    ...
    void setEndWidthAt(int i, double w) { RPolyline::setEndWidthAt(i, w); }

    double getEndWidthAt(int i) const { return RPolyline::getEndWidthAt(i); }

    bool hasWidths() const { return RPolyline::hasWidths(); }
    ...
    QList<double> getStartWidths() const { return RPolyline::getStartWidths(); }

    void setEndWidths(const QList<double> &ew) { RPolyline::setEndWidths(ew); }

    QList<double> getEndWidths() const { return RPolyline::getEndWidths(); }
    ...
    virtual QList<RVector>
    getIntersectionPoints(const REntityData &other, bool limited = true,
                          bool same = false,
                          const RBox &queryBox = RDEFAULT_RBOX,
                          bool ignoreComplex = true) const;

    void setPolylineGen(bool on) { polylineGen = on; }
    bool getPolylineGen() const { return polylineGen; }
