...
void REllipseEntity::init()
{
    ...
    REllipseEntity::PropertyWorkingSet.generateId(REllipseEntity::getRtti(),
                                                  RObject::PropertyWorkingSet);
    REllipseEntity::PropertyType.generateId(REllipseEntity::getRtti(),
                                            REntity::PropertyType);
    REllipseEntity::PropertyBlock.generateId(REllipseEntity::getRtti(),
                                             REntity::PropertyBlock);
    REllipseEntity::PropertyLayer.generateId(REllipseEntity::getRtti(),
                                             REntity::PropertyLayer);
    REllipseEntity::PropertyLinetype.generateId(REllipseEntity::getRtti(),
                                                REntity::PropertyLinetype);
    REllipseEntity::PropertyLinetypeScale.generateId(
            REllipseEntity::getRtti(), REntity::PropertyLinetypeScale);
    REllipseEntity::PropertyLineweight.generateId(REllipseEntity::getRtti(),
                                                  REntity::PropertyLineweight);
    REllipseEntity::PropertyColor.generateId(REllipseEntity::getRtti(),
                                             REntity::PropertyColor);
    REllipseEntity::PropertyDisplayedColor.generateId(
            REllipseEntity::getRtti(), REntity::PropertyDisplayedColor);
    REllipseEntity::PropertyDrawOrder.generateId(REllipseEntity::getRtti(),
                                                 REntity::PropertyDrawOrder);

    REllipseEntity::PropertyCenterX.generateId(
            REllipseEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Center"),
            QT_TRANSLATE_NOOP("REntity", "X"), false,
            RPropertyAttributes::Geometry);
    REllipseEntity::PropertyCenterY.generateId(
            REllipseEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Center"),
            QT_TRANSLATE_NOOP("REntity", "Y"), false,
            RPropertyAttributes::Geometry);
    REllipseEntity::PropertyCenterZ.generateId(
            REllipseEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Center"),
            QT_TRANSLATE_NOOP("REntity", "Z"), false,
            RPropertyAttributes::Geometry);
    REllipseEntity::PropertyMajorPointX.generateId(
            REllipseEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Major Point"),
            QT_TRANSLATE_NOOP("REntity", "X"), false,
            RPropertyAttributes::Geometry);
    REllipseEntity::PropertyMajorPointY.generateId(
            REllipseEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Major Point"),
            QT_TRANSLATE_NOOP("REntity", "Y"), false,
            RPropertyAttributes::Geometry);
    REllipseEntity::PropertyMajorPointZ.generateId(
            REllipseEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Major Point"),
            QT_TRANSLATE_NOOP("REntity", "Z"), false,
            RPropertyAttributes::Geometry);
    REllipseEntity::PropertyRatio.generateId(
            REllipseEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Ratio"), false,
            RPropertyAttributes::Geometry);
    REllipseEntity::PropertyStartParam.generateId(
            REllipseEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Start Parameter"), false,
            RPropertyAttributes::Geometry);
    REllipseEntity::PropertyEndParam.generateId(
            REllipseEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "End Parameter"), false,
            RPropertyAttributes::Geometry);
    REllipseEntity::PropertyStartAngle.generateId(
            REllipseEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Start Angle"), true,
            RPropertyAttributes::Geometry);
    REllipseEntity::PropertyEndAngle.generateId(
            REllipseEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "End Angle"), true,
            RPropertyAttributes::Geometry);
    REllipseEntity::PropertyReversed.generateId(
            REllipseEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Reversed"), false,
            RPropertyAttributes::Geometry);

    REllipseEntity::PropertyStartPointX.generateId(
            REllipseEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Start Point"),
            QT_TRANSLATE_NOOP("REntity", "X"));
    REllipseEntity::PropertyStartPointY.generateId(
            REllipseEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Start Point"),
            QT_TRANSLATE_NOOP("REntity", "Y"));
    REllipseEntity::PropertyStartPointZ.generateId(
            REllipseEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Start Point"),
            QT_TRANSLATE_NOOP("REntity", "Z"));
    REllipseEntity::PropertyEndPointX.generateId(
            REllipseEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "End Point"),
            QT_TRANSLATE_NOOP("REntity", "X"));
    REllipseEntity::PropertyEndPointY.generateId(
            REllipseEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "End Point"),
            QT_TRANSLATE_NOOP("REntity", "Y"));
    REllipseEntity::PropertyEndPointZ.generateId(
            REllipseEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "End Point"),
            QT_TRANSLATE_NOOP("REntity", "Z"));

    REllipseEntity::PropertyCircumference.generateId(
            REllipseEntity::getRtti(), "",
                                 ...
                                 RTransaction *transaction)
{
    ...
    ret = ret || RObject::setMember(data.majorPoint.x, value,
                                    PropertyMajorPointX == propertyTypeId);
    ret = ret || RObject::setMember(data.majorPoint.y, value,
                                    PropertyMajorPointY == propertyTypeId);
    ret = ret || RObject::setMember(data.majorPoint.z, value,
                                    PropertyMajorPointZ == propertyTypeId);
    ret = ret || RObject::setMember(data.ratio, value,
                                    PropertyRatio == propertyTypeId);
    ret = ret || RObject::setMember(data.startParam, value,
                                    PropertyStartParam == propertyTypeId);
    ret = ret || RObject::setMember(data.endParam, value,
                                    PropertyEndParam == propertyTypeId);
    ...
    ret = ret || RObject::setMember(data.reversed, value,
                                    PropertyReversed == propertyTypeId);

    if (ret) { data.correctMajorMinor(); }
    return ret;
}

QPair<QVariant, RPropertyAttributes>
REllipseEntity::getProperty(RPropertyTypeId &propertyTypeId, bool humanReadable,
...
REllipseEntity::scaleNonUniform(const RVector &scaleFactors,
