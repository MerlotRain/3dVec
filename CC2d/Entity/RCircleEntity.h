 ...
 * \ingroup entity
 */
class CC2DCORE_EXPORT RCircleEntity : public REntity
{
public:
...
public:
    ...
    static RS::EntityType getRtti() { return RS::EntityCircle; }
    ...
    virtual RCircleEntity *clone() const { return new RCircleEntity(*this); }
    ...
    virtual RCircleData &getData() { return data; }

    virtual const RCircleData &getData() const { return data; }
