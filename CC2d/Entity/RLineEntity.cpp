...
void RLineEntity::init()
{
    ...
    RLineEntity::PropertyWorkingSet.generateId(RLineEntity::getRtti(),
                                               RObject::PropertyWorkingSet);
    RLineEntity::PropertyType.generateId(RLineEntity::getRtti(),
                                         REntity::PropertyType);
    RLineEntity::PropertyBlock.generateId(RLineEntity::getRtti(),
                                          REntity::PropertyBlock);
    RLineEntity::PropertyLayer.generateId(RLineEntity::getRtti(),
                                          REntity::PropertyLayer);
    RLineEntity::PropertyLinetype.generateId(RLineEntity::getRtti(),
                                             REntity::PropertyLinetype);
    RLineEntity::PropertyLinetypeScale.generateId(
            RLineEntity::getRtti(), REntity::PropertyLinetypeScale);
    RLineEntity::PropertyLineweight.generateId(RLineEntity::getRtti(),
                                               REntity::PropertyLineweight);
    RLineEntity::PropertyColor.generateId(RLineEntity::getRtti(),
                                          REntity::PropertyColor);
    RLineEntity::PropertyDisplayedColor.generateId(
            RLineEntity::getRtti(), REntity::PropertyDisplayedColor);
    RLineEntity::PropertyDrawOrder.generateId(RLineEntity::getRtti(),
                                              REntity::PropertyDrawOrder);

    RLineEntity::PropertyStartPointX.generateId(
            RLineEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Start Point"),
            QT_TRANSLATE_NOOP("REntity", "X"), false,
            RPropertyAttributes::Geometry);
    RLineEntity::PropertyStartPointY.generateId(
            RLineEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Start Point"),
            QT_TRANSLATE_NOOP("REntity", "Y"), false,
            RPropertyAttributes::Geometry);
    RLineEntity::PropertyStartPointZ.generateId(
            RLineEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Start Point"),
            QT_TRANSLATE_NOOP("REntity", "Z"), false,
            RPropertyAttributes::Geometry);
    RLineEntity::PropertyMiddlePointX.generateId(
            RLineEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Middle Point"),
            QT_TRANSLATE_NOOP("REntity", "X"), false,
            RPropertyAttributes::Geometry);
    RLineEntity::PropertyMiddlePointY.generateId(
            RLineEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Middle Point"),
            QT_TRANSLATE_NOOP("REntity", "Y"), false,
            RPropertyAttributes::Geometry);
    RLineEntity::PropertyMiddlePointZ.generateId(
            RLineEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Middle Point"),
            QT_TRANSLATE_NOOP("REntity", "Z"), false,
            RPropertyAttributes::Geometry);
    RLineEntity::PropertyEndPointX.generateId(
            RLineEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "End Point"),
            QT_TRANSLATE_NOOP("REntity", "X"), false,
            RPropertyAttributes::Geometry);
    RLineEntity::PropertyEndPointY.generateId(
            RLineEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "End Point"),
            QT_TRANSLATE_NOOP("REntity", "Y"), false,
            RPropertyAttributes::Geometry);
    RLineEntity::PropertyEndPointZ.generateId(
            RLineEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "End Point"),
            QT_TRANSLATE_NOOP("REntity", "Z"), false,
            RPropertyAttributes::Geometry);

    RLineEntity::PropertyAngle.generateId(
            RLineEntity::getRtti(), "", QT_TRANSLATE_NOOP("REntity", "Angle"));
    RLineEntity::PropertyLength.generateId(
            RLineEntity::getRtti(), "", QT_TRANSLATE_NOOP("REntity", "Length"));
    RLineEntity::PropertyTotalLength.generateId(
            RLineEntity::getRtti(), "",
                              ...
                              const QVariant &value, RTransaction *transaction)
{
    ...
    ret = ret || RObject::setMember(data.startPoint.x, value,
                                    PropertyStartPointX == propertyTypeId);
    ret = ret || RObject::setMember(data.startPoint.y, value,
                                    PropertyStartPointY == propertyTypeId);
    ret = ret || RObject::setMember(data.startPoint.z, value,
                                    PropertyStartPointZ == propertyTypeId);
    ret = ret || RObject::setMember(data.endPoint.x, value,
                                    PropertyEndPointX == propertyTypeId);
    ret = ret || RObject::setMember(data.endPoint.y, value,
                                    PropertyEndPointY == propertyTypeId);
    ret = ret || RObject::setMember(data.endPoint.z, value,
                                    PropertyEndPointZ == propertyTypeId);
...
RLineEntity::getProperty(RPropertyTypeId &propertyTypeId, bool humanReadable,
