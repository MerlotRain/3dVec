...
public:
    ...
    virtual RS::EntityType getType() const { return RS::EntityLine; }

    RLine getLine() { return *this; }

    bool isValid() const { return RLine::isValid(); }
    ...
    virtual void setZ(double z) { RLine::setZ(z); }
    virtual void to2D() { RLine::to2D(); }
    virtual QList<RVector>
    ...
    virtual bool move(const RVector &offset) { return RLine::move(offset); }
    ...
    virtual bool mirror(const RLine &axis) { return RLine::mirror(axis); }
    ...
    RVector getStartPoint() const { return RLine::getStartPoint(); }
    RVector getEndPoint() const { return RLine::getEndPoint(); }
    double getAngle() const { return RLine::getAngle(); }
    double getDirection1() const { return RLine::getDirection1(); }
    double getDirection2() const { return RLine::getDirection2(); }
    bool reverse() { return RLine::reverse(); }
