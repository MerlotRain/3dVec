...
public:
    ...
    virtual RS::EntityType getType() const { return RS::EntityArc; }
    RArc getArc() { return *this; }


    bool isValid() const { return RArc::isValid(); }
    ...
    virtual void setZ(double z) { RArc::setZ(z); }
    virtual void to2D() { RArc::to2D(); }
    ...
    virtual bool move(const RVector &offset) { return RArc::move(offset); }
    ...
    virtual bool mirror(const RLine &axis) { return RArc::mirror(axis); }
    ...
    RVector getCenter() const { return RArc::getCenter(); }
    double getRadius() const { return RArc::getRadius(); }
    double getBulge() const { return RArc::getBulge(); }
    double getStartAngle() const { return RArc::getStartAngle(); }
    double getEndAngle() const { return RArc::getEndAngle(); }
    bool isReversed() const { return RArc::isReversed(); }
    double getDirection1() const { return RArc::getDirection1(); }
    double getDirection2() const { return RArc::getDirection2(); }
    bool reverse() { return RArc::reverse(); }
    ...
    double getLength() const { return RArc::getLength(); }
