...
RDimRadialEntity::RDimRadialEntity(RDocument *document,
                                   const RDimRadialData &data)
...
void RDimRadialEntity::init()
{
    ...
    RDimRadialEntity::PropertyWorkingSet.generateId(
            RDimRadialEntity::getRtti(), RObject::PropertyWorkingSet);
    RDimRadialEntity::PropertyType.generateId(RDimRadialEntity::getRtti(),
                                              REntity::PropertyType);
    RDimRadialEntity::PropertyBlock.generateId(RDimRadialEntity::getRtti(),
                                               REntity::PropertyBlock);
    RDimRadialEntity::PropertyLayer.generateId(RDimRadialEntity::getRtti(),
                                               REntity::PropertyLayer);
    RDimRadialEntity::PropertyLinetype.generateId(RDimRadialEntity::getRtti(),
                                                  REntity::PropertyLinetype);
    RDimRadialEntity::PropertyLinetypeScale.generateId(
            RDimRadialEntity::getRtti(), REntity::PropertyLinetypeScale);
    RDimRadialEntity::PropertyLineweight.generateId(
            RDimRadialEntity::getRtti(), REntity::PropertyLineweight);
    RDimRadialEntity::PropertyColor.generateId(RDimRadialEntity::getRtti(),
                                               REntity::PropertyColor);
    RDimRadialEntity::PropertyDisplayedColor.generateId(
            RDimRadialEntity::getRtti(), REntity::PropertyDisplayedColor);
    RDimRadialEntity::PropertyDrawOrder.generateId(RDimRadialEntity::getRtti(),
                                                   REntity::PropertyDrawOrder);

    RDimRadialEntity::PropertyMiddleOfTextX.generateId(
            RDimRadialEntity::getRtti(),
            RDimensionEntity::PropertyMiddleOfTextX);
    RDimRadialEntity::PropertyMiddleOfTextY.generateId(
            RDimRadialEntity::getRtti(),
            RDimensionEntity::PropertyMiddleOfTextY);
    RDimRadialEntity::PropertyMiddleOfTextZ.generateId(
            RDimRadialEntity::getRtti(),
            RDimensionEntity::PropertyMiddleOfTextZ);

    RDimRadialEntity::PropertyText.generateId(RDimRadialEntity::getRtti(),
                                              RDimensionEntity::PropertyText);
    RDimRadialEntity::PropertyUpperTolerance.generateId(
            RDimRadialEntity::getRtti(),
            RDimensionEntity::PropertyUpperTolerance);
    RDimRadialEntity::PropertyLowerTolerance.generateId(
            RDimRadialEntity::getRtti(),
            RDimensionEntity::PropertyLowerTolerance);
    RDimRadialEntity::PropertyMeasuredValue.generateId(
            RDimRadialEntity::getRtti(),
            RDimensionEntity::PropertyMeasuredValue);

    RDimRadialEntity::PropertyDimscale.generateId(
            RDimRadialEntity::getRtti(), RDimensionEntity::PropertyDimscale);
    RDimRadialEntity::PropertyDimlfac.generateId(
            RDimRadialEntity::getRtti(), RDimensionEntity::PropertyDimlfac);
    RDimRadialEntity::PropertyDimtxt.generateId(
            RDimRadialEntity::getRtti(), RDimensionEntity::PropertyDimtxt);
    RDimRadialEntity::PropertyDimgap.generateId(
            RDimRadialEntity::getRtti(), RDimensionEntity::PropertyDimgap);
    RDimRadialEntity::PropertyDimasz.generateId(
            RDimRadialEntity::getRtti(), RDimensionEntity::PropertyDimasz);
    //RDimRadialEntity::PropertyDimdli.generateId(RDimRadialEntity::getRtti(), RDimensionEntity::PropertyDimdli);
    RDimRadialEntity::PropertyDimexe.generateId(
            RDimRadialEntity::getRtti(), RDimensionEntity::PropertyDimexe);
    RDimRadialEntity::PropertyDimexo.generateId(
            RDimRadialEntity::getRtti(), RDimensionEntity::PropertyDimexo);
    RDimRadialEntity::PropertyDimtad.generateId(
            RDimRadialEntity::getRtti(), RDimensionEntity::PropertyDimtad);
    RDimRadialEntity::PropertyDimtih.generateId(
            RDimRadialEntity::getRtti(), RDimensionEntity::PropertyDimtih);
    RDimRadialEntity::PropertyDimtsz.generateId(
            RDimRadialEntity::getRtti(), RDimensionEntity::PropertyDimtsz);
    RDimRadialEntity::PropertyDimlunit.generateId(
            RDimRadialEntity::getRtti(), RDimensionEntity::PropertyDimlunit);
    RDimRadialEntity::PropertyDimdec.generateId(
            RDimRadialEntity::getRtti(), RDimensionEntity::PropertyDimdec);
    RDimRadialEntity::PropertyDimdsep.generateId(
            RDimRadialEntity::getRtti(), RDimensionEntity::PropertyDimdsep);
    RDimRadialEntity::PropertyDimzin.generateId(
            RDimRadialEntity::getRtti(), RDimensionEntity::PropertyDimzin);
    ...
    RDimRadialEntity::PropertyArchTick.generateId(
            RDimRadialEntity::getRtti(), RDimensionEntity::PropertyArchTick);
    RDimRadialEntity::PropertyDimclrt.generateId(
            RDimRadialEntity::getRtti(), RDimensionEntity::PropertyDimclrt);
    ...
    RDimRadialEntity::PropertyDimBlockName.generateId(
            RDimRadialEntity::getRtti(),
            RDimensionEntity::PropertyDimBlockName);
    RDimRadialEntity::PropertyAutoTextPos.generateId(
            RDimRadialEntity::getRtti(), RDimensionEntity::PropertyAutoTextPos);
    RDimRadialEntity::PropertyFontName.generateId(
            RDimRadialEntity::getRtti(), RDimensionEntity::PropertyFontName);
    RDimRadialEntity::PropertyArrow1Flipped.generateId(
            RDimRadialEntity::getRtti(),
    ...
    RDimRadialEntity::PropertyCenterPointX.generateId(
            RDimRadialEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Center"),
            QT_TRANSLATE_NOOP("REntity", "X"), true,
            RPropertyAttributes::Geometry);
    RDimRadialEntity::PropertyCenterPointY.generateId(
            RDimRadialEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Center"),
            QT_TRANSLATE_NOOP("REntity", "Y"), true,
            RPropertyAttributes::Geometry);
    RDimRadialEntity::PropertyCenterPointZ.generateId(
            RDimRadialEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Center"),
            QT_TRANSLATE_NOOP("REntity", "Z"), true,
            RPropertyAttributes::Geometry);

    RDimRadialEntity::PropertyChordPointX.generateId(
            RDimRadialEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Chord Point"),
            QT_TRANSLATE_NOOP("REntity", "X"), false,
            RPropertyAttributes::Geometry);
    RDimRadialEntity::PropertyChordPointY.generateId(
            RDimRadialEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Chord Point"),
            QT_TRANSLATE_NOOP("REntity", "Y"), false,
            RPropertyAttributes::Geometry);
    RDimRadialEntity::PropertyChordPointZ.generateId(
            RDimRadialEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Chord Point"),
...
RDimRadialEntity::getProperty(RPropertyTypeId &propertyTypeId,
