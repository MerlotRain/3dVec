...
public:
    ...
    virtual RS::EntityType getType() const { return RS::EntityDimLinear; }
    ...
    void setExtensionPoint1(const RVector &p) { extensionPoint1 = p; }

    RVector getExtensionPoint1() const { return extensionPoint1; }

    void setExtensionPoint2(const RVector &p) { extensionPoint2 = p; }

    RVector getExtensionPoint2() const { return extensionPoint2; }

    virtual void recomputeDefinitionPoint(const RVector &oldExtPoint1,
