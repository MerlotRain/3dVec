...
public:
    ...
    static RS::EntityType getRtti() { return RS::EntityDimArcLength; }
    ...
    virtual RDimArcLengthData &getData() { return data; }

    void setData(RDimArcLengthData &d) { data = d; }

    virtual const RDimArcLengthData &getData() const { return data; }
