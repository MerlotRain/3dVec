 ...
 * \ingroup entity
 */
class CC2DCORE_EXPORT RLineEntity : public REntity
{
public:
...
public:
    ...
    static RS::EntityType getRtti() { return RS::EntityLine; }
    ...
    virtual RLineEntity *clone() const { return new RLineEntity(*this); }
    ...
    void setStartPoint(const RVector &p) { data.setStartPoint(p); }

    RVector getStartPoint() const { return data.getStartPoint(); }

    void setEndPoint(const RVector &p) { data.setEndPoint(p); }

    RVector getEndPoint() const { return data.getEndPoint(); }

    RVector getMiddlePoint() const { return getData().getMiddlePoint(); }
