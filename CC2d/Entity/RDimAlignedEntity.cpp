...
RDimAlignedEntity::RDimAlignedEntity(RDocument *document,
                                     const RDimAlignedData &data)
...
void RDimAlignedEntity::init()
{
    ...
    RDimAlignedEntity::PropertyProtected.generateId(
            RDimAlignedEntity::getRtti(), RObject::PropertyProtected);
    RDimAlignedEntity::PropertyWorkingSet.generateId(
            RDimAlignedEntity::getRtti(), RObject::PropertyWorkingSet);
    RDimAlignedEntity::PropertyType.generateId(RDimAlignedEntity::getRtti(),
                                               REntity::PropertyType);
    RDimAlignedEntity::PropertyBlock.generateId(RDimAlignedEntity::getRtti(),
                                                REntity::PropertyBlock);
    RDimAlignedEntity::PropertyLayer.generateId(RDimAlignedEntity::getRtti(),
                                                REntity::PropertyLayer);
    RDimAlignedEntity::PropertyLinetype.generateId(RDimAlignedEntity::getRtti(),
                                                   REntity::PropertyLinetype);
    RDimAlignedEntity::PropertyLinetypeScale.generateId(
            RDimAlignedEntity::getRtti(), REntity::PropertyLinetypeScale);
    RDimAlignedEntity::PropertyLineweight.generateId(
            RDimAlignedEntity::getRtti(), REntity::PropertyLineweight);
    RDimAlignedEntity::PropertyColor.generateId(RDimAlignedEntity::getRtti(),
                                                REntity::PropertyColor);
    RDimAlignedEntity::PropertyDisplayedColor.generateId(
            RDimAlignedEntity::getRtti(), REntity::PropertyDisplayedColor);
    RDimAlignedEntity::PropertyDrawOrder.generateId(
            RDimAlignedEntity::getRtti(), REntity::PropertyDrawOrder);

    RDimAlignedEntity::PropertyMiddleOfTextX.generateId(
            RDimAlignedEntity::getRtti(),
            RDimensionEntity::PropertyMiddleOfTextX);
    RDimAlignedEntity::PropertyMiddleOfTextY.generateId(
            RDimAlignedEntity::getRtti(),
            RDimensionEntity::PropertyMiddleOfTextY);
    RDimAlignedEntity::PropertyMiddleOfTextZ.generateId(
            RDimAlignedEntity::getRtti(),
            RDimensionEntity::PropertyMiddleOfTextZ);
    RDimAlignedEntity::PropertyText.generateId(RDimAlignedEntity::getRtti(),
                                               RDimensionEntity::PropertyText);
    RDimAlignedEntity::PropertyUpperTolerance.generateId(
            RDimAlignedEntity::getRtti(),
            RDimensionEntity::PropertyUpperTolerance);
    RDimAlignedEntity::PropertyLowerTolerance.generateId(
            RDimAlignedEntity::getRtti(),
            RDimensionEntity::PropertyLowerTolerance);
    RDimAlignedEntity::PropertyMeasuredValue.generateId(
            RDimAlignedEntity::getRtti(),
            RDimensionEntity::PropertyMeasuredValue);

    RDimAlignedEntity::PropertyDimscale.generateId(
            RDimAlignedEntity::getRtti(), RDimensionEntity::PropertyDimscale);
    RDimAlignedEntity::PropertyDimlfac.generateId(
            RDimAlignedEntity::getRtti(), RDimensionEntity::PropertyDimlfac);
    RDimAlignedEntity::PropertyDimtxt.generateId(
            RDimAlignedEntity::getRtti(), RDimensionEntity::PropertyDimtxt);
    RDimAlignedEntity::PropertyDimgap.generateId(
            RDimAlignedEntity::getRtti(), RDimensionEntity::PropertyDimgap);
    RDimAlignedEntity::PropertyDimasz.generateId(
            RDimAlignedEntity::getRtti(), RDimensionEntity::PropertyDimasz);
    //RDimAlignedEntity::PropertyDimdli.generateId(RDimAlignedEntity::getRtti(), RDimensionEntity::PropertyDimdli);
    RDimAlignedEntity::PropertyDimexe.generateId(
            RDimAlignedEntity::getRtti(), RDimensionEntity::PropertyDimexe);
    RDimAlignedEntity::PropertyDimexo.generateId(
            RDimAlignedEntity::getRtti(), RDimensionEntity::PropertyDimexo);
    RDimAlignedEntity::PropertyDimtad.generateId(
            RDimAlignedEntity::getRtti(), RDimensionEntity::PropertyDimtad);
    RDimAlignedEntity::PropertyDimtih.generateId(
            RDimAlignedEntity::getRtti(), RDimensionEntity::PropertyDimtih);
    RDimAlignedEntity::PropertyDimtsz.generateId(
            RDimAlignedEntity::getRtti(), RDimensionEntity::PropertyDimtsz);
    RDimAlignedEntity::PropertyDimlunit.generateId(
            RDimAlignedEntity::getRtti(), RDimensionEntity::PropertyDimlunit);
    RDimAlignedEntity::PropertyDimdec.generateId(
            RDimAlignedEntity::getRtti(), RDimensionEntity::PropertyDimdec);
    RDimAlignedEntity::PropertyDimdsep.generateId(
            RDimAlignedEntity::getRtti(), RDimensionEntity::PropertyDimdsep);
    RDimAlignedEntity::PropertyDimzin.generateId(
            RDimAlignedEntity::getRtti(), RDimensionEntity::PropertyDimzin);
    ...
    RDimAlignedEntity::PropertyArchTick.generateId(
            RDimAlignedEntity::getRtti(), RDimensionEntity::PropertyArchTick);
    RDimAlignedEntity::PropertyDimclrt.generateId(
            RDimAlignedEntity::getRtti(), RDimensionEntity::PropertyDimclrt);
    ...
    RDimAlignedEntity::PropertyDimBlockName.generateId(
            RDimAlignedEntity::getRtti(),
            RDimensionEntity::PropertyDimBlockName);
    RDimAlignedEntity::PropertyAutoTextPos.generateId(
            RDimAlignedEntity::getRtti(),
            RDimensionEntity::PropertyAutoTextPos);
    RDimAlignedEntity::PropertyFontName.generateId(
            RDimAlignedEntity::getRtti(), RDimensionEntity::PropertyFontName);
    RDimAlignedEntity::PropertyArrow1Flipped.generateId(
            RDimAlignedEntity::getRtti(),
            RDimensionEntity::PropertyArrow1Flipped);
    RDimAlignedEntity::PropertyArrow2Flipped.generateId(
            RDimAlignedEntity::getRtti(),
            RDimensionEntity::PropertyArrow2Flipped);

    RDimAlignedEntity::PropertyExtLineFix.generateId(
            RDimAlignedEntity::getRtti(), RDimensionEntity::PropertyExtLineFix);
    RDimAlignedEntity::PropertyExtLineFixLength.generateId(
            RDimAlignedEntity::getRtti(),
            RDimensionEntity::PropertyExtLineFixLength);

    RDimAlignedEntity::PropertyDimensionLinePosX.generateId(
            RDimAlignedEntity::getRtti(),
            RDimLinearEntity::PropertyDimensionLinePosX);
    RDimAlignedEntity::PropertyDimensionLinePosY.generateId(
            RDimAlignedEntity::getRtti(),
            RDimLinearEntity::PropertyDimensionLinePosY);
    RDimAlignedEntity::PropertyDimensionLinePosZ.generateId(
            RDimAlignedEntity::getRtti(),
            RDimLinearEntity::PropertyDimensionLinePosZ);

    RDimAlignedEntity::PropertyExtensionPoint1X.generateId(
            RDimAlignedEntity::getRtti(),
            RDimLinearEntity::PropertyExtensionPoint1X);
    RDimAlignedEntity::PropertyExtensionPoint1Y.generateId(
            RDimAlignedEntity::getRtti(),
            RDimLinearEntity::PropertyExtensionPoint1Y);
    RDimAlignedEntity::PropertyExtensionPoint1Z.generateId(
            RDimAlignedEntity::getRtti(),
            RDimLinearEntity::PropertyExtensionPoint1Z);

    RDimAlignedEntity::PropertyExtensionPoint2X.generateId(
            RDimAlignedEntity::getRtti(),
            RDimLinearEntity::PropertyExtensionPoint2X);
    RDimAlignedEntity::PropertyExtensionPoint2Y.generateId(
            RDimAlignedEntity::getRtti(),
            RDimLinearEntity::PropertyExtensionPoint2Y);
    RDimAlignedEntity::PropertyExtensionPoint2Z.generateId(
            RDimAlignedEntity::getRtti(),
...
RDimAlignedEntity::getProperty(RPropertyTypeId &propertyTypeId,
                               ...
                               bool showOnRequest)
{
    ...
    return RDimLinearEntity::getProperty(propertyTypeId, humanReadable,
