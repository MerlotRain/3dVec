 ...
 * \ingroup entity
 */
class CC2DCORE_EXPORT RFaceEntity : public REntity
{
public:
...
public:
    ...
    static RS::EntityType getRtti() { return RS::EntityFace; }
    ...
    virtual RFaceEntity *clone() const { return new RFaceEntity(*this); }
