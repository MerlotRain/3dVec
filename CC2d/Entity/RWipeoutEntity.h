...
public:
    ...
    static RS::EntityType getRtti() { return RS::EntityWipeout; }
    ...
    virtual RWipeoutEntity *clone() const { return new RWipeoutEntity(*this); }

    virtual RWipeoutData &getData() { return data; }

    virtual const RWipeoutData &getData() const { return data; }
    ...
    void setShowFrame(bool on) { data.setShowFrame(on); }
