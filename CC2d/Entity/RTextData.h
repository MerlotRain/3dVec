...
public:
    ...
    RTextData(const RVector &position, const RVector &alignmentPoint,
              double textHeight, double textWidth, RS::VAlign verticalAlignment,
              ...
              const QString &fontName, bool bold, bool italic, double angle,
              bool simple);
