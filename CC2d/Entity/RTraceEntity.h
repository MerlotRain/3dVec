 ...
 * \ingroup entity
 */
class CC2DCORE_EXPORT RTraceEntity : public REntity
{
...
public:
    ...
    static RS::EntityType getRtti() { return RS::EntityTrace; }
    ...
    virtual RTraceEntity *clone() const { return new RTraceEntity(*this); }
