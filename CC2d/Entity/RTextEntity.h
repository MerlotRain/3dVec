...
public:
    ...
    static RS::EntityType getRtti() { return RS::EntityText; }
    ...
    virtual RTextEntity *clone() const { return new RTextEntity(*this); }

    virtual RTextData &getData() { return data; }

    void setData(RTextData &d) { data = d; }

    virtual const RTextData &getData() const { return data; }
