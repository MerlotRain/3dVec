...
RDimDiametricEntity::RDimDiametricEntity(RDocument *document,
...
void RDimDiametricEntity::init()
{
    ...
    RDimDiametricEntity::PropertyProtected.generateId(
            RDimDiametricEntity::getRtti(), RObject::PropertyProtected);
    RDimDiametricEntity::PropertyWorkingSet.generateId(
            RDimDiametricEntity::getRtti(), RObject::PropertyWorkingSet);
    RDimDiametricEntity::PropertyType.generateId(RDimDiametricEntity::getRtti(),
                                                 REntity::PropertyType);
    RDimDiametricEntity::PropertyBlock.generateId(
            RDimDiametricEntity::getRtti(), REntity::PropertyBlock);
    RDimDiametricEntity::PropertyLayer.generateId(
            RDimDiametricEntity::getRtti(), REntity::PropertyLayer);
    RDimDiametricEntity::PropertyLinetype.generateId(
            RDimDiametricEntity::getRtti(), REntity::PropertyLinetype);
    RDimDiametricEntity::PropertyLinetypeScale.generateId(
            RDimDiametricEntity::getRtti(), REntity::PropertyLinetypeScale);
    RDimDiametricEntity::PropertyLineweight.generateId(
            RDimDiametricEntity::getRtti(), REntity::PropertyLineweight);
    RDimDiametricEntity::PropertyColor.generateId(
            RDimDiametricEntity::getRtti(), REntity::PropertyColor);
    RDimDiametricEntity::PropertyDisplayedColor.generateId(
            RDimDiametricEntity::getRtti(), REntity::PropertyDisplayedColor);
    RDimDiametricEntity::PropertyDrawOrder.generateId(
            RDimDiametricEntity::getRtti(), REntity::PropertyDrawOrder);

    RDimDiametricEntity::PropertyMiddleOfTextX.generateId(
            RDimDiametricEntity::getRtti(),
            RDimensionEntity::PropertyMiddleOfTextX);
    RDimDiametricEntity::PropertyMiddleOfTextY.generateId(
            RDimDiametricEntity::getRtti(),
            RDimensionEntity::PropertyMiddleOfTextY);
    RDimDiametricEntity::PropertyMiddleOfTextZ.generateId(
            RDimDiametricEntity::getRtti(),
            RDimensionEntity::PropertyMiddleOfTextZ);

    RDimDiametricEntity::PropertyText.generateId(
            RDimDiametricEntity::getRtti(), RDimensionEntity::PropertyText);
    RDimDiametricEntity::PropertyUpperTolerance.generateId(
            RDimDiametricEntity::getRtti(),
            RDimensionEntity::PropertyUpperTolerance);
    RDimDiametricEntity::PropertyLowerTolerance.generateId(
            RDimDiametricEntity::getRtti(),
            RDimensionEntity::PropertyLowerTolerance);
    RDimDiametricEntity::PropertyMeasuredValue.generateId(
            RDimDiametricEntity::getRtti(),
            RDimensionEntity::PropertyMeasuredValue);

    RDimDiametricEntity::PropertyDimscale.generateId(
            RDimDiametricEntity::getRtti(), RDimensionEntity::PropertyDimscale);
    RDimDiametricEntity::PropertyDimlfac.generateId(
            RDimDiametricEntity::getRtti(), RDimensionEntity::PropertyDimlfac);
    RDimDiametricEntity::PropertyDimtxt.generateId(
            RDimDiametricEntity::getRtti(), RDimensionEntity::PropertyDimtxt);
    RDimDiametricEntity::PropertyDimgap.generateId(
            RDimDiametricEntity::getRtti(), RDimensionEntity::PropertyDimgap);
    RDimDiametricEntity::PropertyDimasz.generateId(
            RDimDiametricEntity::getRtti(), RDimensionEntity::PropertyDimasz);
    //RDimDiametricEntity::PropertyDimdli.generateId(RDimDiametricEntity::getRtti(), RDimensionEntity::PropertyDimdli);
    RDimDiametricEntity::PropertyDimexe.generateId(
            RDimDiametricEntity::getRtti(), RDimensionEntity::PropertyDimexe);
    RDimDiametricEntity::PropertyDimexo.generateId(
            RDimDiametricEntity::getRtti(), RDimensionEntity::PropertyDimexo);
    RDimDiametricEntity::PropertyDimtad.generateId(
            RDimDiametricEntity::getRtti(), RDimensionEntity::PropertyDimtad);
    RDimDiametricEntity::PropertyDimtih.generateId(
            RDimDiametricEntity::getRtti(), RDimensionEntity::PropertyDimtih);
    RDimDiametricEntity::PropertyDimtsz.generateId(
            RDimDiametricEntity::getRtti(), RDimensionEntity::PropertyDimtsz);
    RDimDiametricEntity::PropertyDimlunit.generateId(
            RDimDiametricEntity::getRtti(), RDimensionEntity::PropertyDimlunit);
    RDimDiametricEntity::PropertyDimdec.generateId(
            RDimDiametricEntity::getRtti(), RDimensionEntity::PropertyDimdec);
    RDimDiametricEntity::PropertyDimdsep.generateId(
            RDimDiametricEntity::getRtti(), RDimensionEntity::PropertyDimdsep);
    RDimDiametricEntity::PropertyDimzin.generateId(
            RDimDiametricEntity::getRtti(), RDimensionEntity::PropertyDimzin);
    ...
    RDimDiametricEntity::PropertyArchTick.generateId(
            RDimDiametricEntity::getRtti(), RDimensionEntity::PropertyArchTick);
    RDimDiametricEntity::PropertyDimclrt.generateId(
            RDimDiametricEntity::getRtti(), RDimensionEntity::PropertyDimclrt);
    ...
    RDimDiametricEntity::PropertyDimBlockName.generateId(
            RDimDiametricEntity::getRtti(),
            RDimensionEntity::PropertyDimBlockName);
    RDimDiametricEntity::PropertyAutoTextPos.generateId(
            RDimDiametricEntity::getRtti(),
            RDimensionEntity::PropertyAutoTextPos);
    RDimDiametricEntity::PropertyFontName.generateId(
            RDimDiametricEntity::getRtti(), RDimensionEntity::PropertyFontName);
    RDimDiametricEntity::PropertyArrow1Flipped.generateId(
            RDimDiametricEntity::getRtti(),
            RDimensionEntity::PropertyArrow1Flipped);
    RDimDiametricEntity::PropertyArrow2Flipped.generateId(
            RDimDiametricEntity::getRtti(),
            RDimensionEntity::PropertyArrow2Flipped);

    RDimDiametricEntity::PropertyExtLineFix.generateId(
            RDimDiametricEntity::getRtti(),
            RDimensionEntity::PropertyExtLineFix);
    RDimDiametricEntity::PropertyExtLineFixLength.generateId(
            RDimDiametricEntity::getRtti(),
            RDimensionEntity::PropertyExtLineFixLength);

    RDimDiametricEntity::PropertyChordPointX.generateId(
            RDimDiametricEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Chord Point"),
            QT_TRANSLATE_NOOP("REntity", "X"), false,
            RPropertyAttributes::Geometry);
    RDimDiametricEntity::PropertyChordPointY.generateId(
            RDimDiametricEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Chord Point"),
            QT_TRANSLATE_NOOP("REntity", "Y"), false,
            RPropertyAttributes::Geometry);
    RDimDiametricEntity::PropertyChordPointZ.generateId(
            RDimDiametricEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Chord Point"),
            QT_TRANSLATE_NOOP("REntity", "Z"), false,
            RPropertyAttributes::Geometry);

    RDimDiametricEntity::PropertyFarChordPointX.generateId(
            RDimDiametricEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Far Chord Point"),
            QT_TRANSLATE_NOOP("REntity", "X"), false,
            RPropertyAttributes::Geometry);
    RDimDiametricEntity::PropertyFarChordPointY.generateId(
            RDimDiametricEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Far Chord Point"),
            QT_TRANSLATE_NOOP("REntity", "Y"), false,
            RPropertyAttributes::Geometry);
    RDimDiametricEntity::PropertyFarChordPointZ.generateId(
            RDimDiametricEntity::getRtti(),
            QT_TRANSLATE_NOOP("REntity", "Far Chord Point"),
            QT_TRANSLATE_NOOP("REntity", "Z"), false,
            RPropertyAttributes::Geometry);
                                      ...
                                      RTransaction *transaction)
{
    ...
    ret = ret || RObject::setMember(data.definitionPoint.x, value,
                                    PropertyChordPointX == propertyTypeId);
    ret = ret || RObject::setMember(data.definitionPoint.y, value,
                                    PropertyChordPointY == propertyTypeId);
    ret = ret || RObject::setMember(data.definitionPoint.z, value,
                                    PropertyChordPointZ == propertyTypeId);
    ret = ret || RObject::setMember(data.chordPoint.x, value,
                                    PropertyFarChordPointX == propertyTypeId);
    ret = ret || RObject::setMember(data.chordPoint.y, value,
                                    PropertyFarChordPointY == propertyTypeId);
    ret = ret || RObject::setMember(data.chordPoint.z, value,
                                    PropertyFarChordPointZ == propertyTypeId);
...
RDimDiametricEntity::getProperty(RPropertyTypeId &propertyTypeId,
