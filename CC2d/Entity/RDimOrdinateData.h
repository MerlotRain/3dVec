...
public:
    ...
    virtual RS::EntityType getType() const { return RS::EntityDimOrdinate; }
    ...
    RVector getLeaderEndPoint() const { return leaderEndPoint; }

    void setOrigin(const RVector &p) { setDefinitionPoint(p); }

    RVector getOrigin() const { return getDefinitionPoint(); }
    ...
    RVector getDefiningPoint() const { return definingPoint; }
    ...
    bool isMeasuringXAxis() const { return xType; }
