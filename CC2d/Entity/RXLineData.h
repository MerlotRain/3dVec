 ...
 * \ingroup entity
 */
class CC2DCORE_EXPORT RXLineData : public REntityData, public RXLine
{
...
public:
    ...
    virtual RS::EntityType getType() const { return RS::EntityXLine; }
    RXLine getXLine() { return *this; }

    bool isValid() const { return RXLine::isValid(); }
    ...
    virtual void setZ(double z) { RXLine::setZ(z); }
    virtual void to2D() { RXLine::to2D(); }
    ...
    virtual bool move(const RVector &offset) { return RXLine::move(offset); }
    ...
    virtual bool mirror(const RLine &axis) { return RXLine::mirror(axis); }
    ...
    RVector getBasePoint() const { return RXLine::getBasePoint(); }
    RVector getDirectionVector() const { return RXLine::getDirectionVector(); }
    double getAngle() const { return RXLine::getAngle(); }

    bool hasFixedAngle() const { return fixedAngle; }

    void setFixedAngle(bool on) { fixedAngle = on; }

    bool reverse() { return RXLine::reverse(); }
