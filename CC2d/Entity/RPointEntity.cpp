...
void RPointEntity::init()
{
    ...
    RPointEntity::PropertyWorkingSet.generateId(RPointEntity::getRtti(),
                                                RObject::PropertyWorkingSet);
    RPointEntity::PropertyType.generateId(RPointEntity::getRtti(),
                                          REntity::PropertyType);
    RPointEntity::PropertyBlock.generateId(RPointEntity::getRtti(),
                                           REntity::PropertyBlock);
    RPointEntity::PropertyLayer.generateId(RPointEntity::getRtti(),
                                           REntity::PropertyLayer);
    RPointEntity::PropertyLinetype.generateId(RPointEntity::getRtti(),
                                              REntity::PropertyLinetype);
    RPointEntity::PropertyLinetypeScale.generateId(
            RPointEntity::getRtti(), REntity::PropertyLinetypeScale);
    RPointEntity::PropertyLineweight.generateId(RPointEntity::getRtti(),
                                                REntity::PropertyLineweight);
    RPointEntity::PropertyColor.generateId(RPointEntity::getRtti(),
                                           REntity::PropertyColor);
    RPointEntity::PropertyDisplayedColor.generateId(
            RPointEntity::getRtti(), REntity::PropertyDisplayedColor);
    RPointEntity::PropertyDrawOrder.generateId(RPointEntity::getRtti(),
                                               REntity::PropertyDrawOrder);

    RPointEntity::PropertyPositionX.generateId(
            RPointEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Position"),
            QT_TRANSLATE_NOOP("REntity", "X"), false,
            RPropertyAttributes::Geometry);
    RPointEntity::PropertyPositionY.generateId(
            RPointEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Position"),
            QT_TRANSLATE_NOOP("REntity", "Y"), false,
            RPropertyAttributes::Geometry);
    RPointEntity::PropertyPositionZ.generateId(
            RPointEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Position"),
...
RPointEntity::getProperty(RPropertyTypeId &propertyTypeId, bool humanReadable,
