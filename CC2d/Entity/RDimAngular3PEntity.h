 ...
 * \ingroup entity
 */
class CC2DCORE_EXPORT RDimAngular3PEntity : public RDimAngularEntity
{
...
public:
    ...
    static RS::EntityType getRtti() { return RS::EntityDimAngular3P; }
    ...
    virtual RDimAngular3PData &getData() { return data; }

    void setData(RDimAngular3PData &d) { data = d; }

    virtual const RDimAngular3PData &getData() const { return data; }

    void setCenter(const RVector &p) { getData().setCenter(p); }
