...
RTextData::RTextData(const RTextBasedData &data) : RTextBasedData(data) {}

RTextData::RTextData(const RVector &position, const RVector &alignmentPoint,
    ...
    : RTextBasedData(position, alignmentPoint, textHeight, textWidth,
                     verticalAlignment, horizontalAlignment, drawingDirection,
                     lineSpacingStyle, lineSpacingFactor, text, fontName, bold,
                     italic, angle, simple)
{
}
