...
public:
    ...
    static RS::EntityType getRtti() { return RS::EntitySpline; }
    ...
    virtual RSplineEntity *clone() const { return new RSplineEntity(*this); }
    ...
    virtual RSplineData &getData() { return data; }

    virtual const RSplineData &getData() const { return data; }

    void setShape(const RSpline &s);

    bool isValid() const { return data.isValid(); }

    double getTDelta() const { return data.getTDelta(); }

    double getTMin() const { return data.getTMin(); }

    double getTMax() const { return data.getTMax(); }
    ...
    int getDegree() const { return data.getDegree(); }
    ...
    RVector getTangentAtStart() const { return data.getTangentAtStart(); }

    RVector getTangentAtEnd() const { return data.getTangentAtEnd(); }
    ...
    bool isPeriodic() const { return data.isPeriodic(); }
    ...
    void appendFitPoint(const RVector &point) { data.appendFitPoint(point); }

    void prependFitPoint(const RVector &point) { data.prependFitPoint(point); }
    ...
    void setPeriodic(bool on) { data.setPeriodic(on); }

    QList<RVector> getControlPoints() const { return data.getControlPoints(); }
    ...
    int countControlPoints() const { return data.countControlPoints(); }

    RVector getControlPointAt(int i) const { return data.getControlPointAt(i); }

    QList<RVector> getFitPoints() const { return data.getFitPoints(); }

    bool hasFitPoints() const { return data.hasFitPoints(); }

    int countFitPoints() const { return data.countFitPoints(); }

    RVector getFitPointAt(int i) const { return data.getFitPointAt(i); }

    QList<double> getKnotVector() const { return data.getKnotVector(); }
    ...
    QList<double> getWeights() const { return data.getWeights(); }
    ...
    RVector getPointAt(double t) const { return data.getPointAt(t); }
    ...
    void setStartPoint(const RVector &sp) { return data.setStartPoint(sp); }

    void setEndPoint(const RVector &ep) { return data.setEndPoint(ep); }
    ...
    void simplify(double tolerance) { data.simplify(tolerance); }
