...
public:
    ...
    static RS::EntityType getRtti() { return RS::EntityTolerance; }
    ...
    virtual RToleranceData &getData() { return data; }

    void setData(RToleranceData &d) { data = d; }

    virtual const RToleranceData &getData() const { return data; }

    void setLocation(const RVector &l) { data.setLocation(l); }

    RVector getLocation() const { return data.getLocation(); }

    void setDirection(const RVector &p) { data.setDirection(p); }

    RVector getDirection() const { return data.getDirection(); }

    void setText(const QString &t) { data.setText(t); }

    QString getText() const { return data.getText(); }

    double getDimtxt(bool scale = true) const { return data.getDimtxt(scale); }

    void setDimtxt(double v) { data.setDimtxt(v); }
    ...
    QList<RTextData> getTextLabels() const { return data.getTextLabels(); }

    QList<RLine> getFrame() const { return data.getFrame(); }

    int getRows() const { return data.getRows(); }
