 ...
 * \ingroup entity
 */
class CC2DCORE_EXPORT RDimAngular2LData : public RDimAngularData
{
...
public:
    ...
    virtual RS::EntityType getType() const { return RS::EntityDimAngular2L; }
    ...
    RVector getExtensionLine1Start() const { return extensionLine1Start; }
    ...
    RVector getExtensionLine2Start() const { return extensionLine2Start; }

    void setExtensionLine2End(const RVector &p) { setDefinitionPoint(p); }

    RVector getExtensionLine2End() const { return getDefinitionPoint(); }
    ...
    RVector getDimArcPosition() const { return dimArcPosition; }
