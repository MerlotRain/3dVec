...
void RWipeoutEntity::init()
{
    ...
    RWipeoutEntity::PropertyWorkingSet.generateId(RWipeoutEntity::getRtti(),
                                                  RObject::PropertyWorkingSet);
    RWipeoutEntity::PropertyType.generateId(RWipeoutEntity::getRtti(),
                                            REntity::PropertyType);
    RWipeoutEntity::PropertyBlock.generateId(RWipeoutEntity::getRtti(),
                                             REntity::PropertyBlock);
    RWipeoutEntity::PropertyLayer.generateId(RWipeoutEntity::getRtti(),
                                             REntity::PropertyLayer);
    RWipeoutEntity::PropertyLinetype.generateId(RWipeoutEntity::getRtti(),
                                                REntity::PropertyLinetype);
    RWipeoutEntity::PropertyLinetypeScale.generateId(
            RWipeoutEntity::getRtti(), REntity::PropertyLinetypeScale);
    RWipeoutEntity::PropertyLineweight.generateId(RWipeoutEntity::getRtti(),
                                                  REntity::PropertyLineweight);
    RWipeoutEntity::PropertyColor.generateId(RWipeoutEntity::getRtti(),
                                             REntity::PropertyColor);
    RWipeoutEntity::PropertyDisplayedColor.generateId(
            RWipeoutEntity::getRtti(), REntity::PropertyDisplayedColor);
    RWipeoutEntity::PropertyDrawOrder.generateId(RWipeoutEntity::getRtti(),
                                                 REntity::PropertyDrawOrder);

    RWipeoutEntity::PropertyVertexNX.generateId(
            RWipeoutEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Vertex"),
            QT_TRANSLATE_NOOP("REntity", "X"), false,
            RPropertyAttributes::Geometry);
    RWipeoutEntity::PropertyVertexNY.generateId(
            RWipeoutEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Vertex"),
            QT_TRANSLATE_NOOP("REntity", "Y"), false,
            RPropertyAttributes::Geometry);
    RWipeoutEntity::PropertyVertexNZ.generateId(
            RWipeoutEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Vertex"),
            QT_TRANSLATE_NOOP("REntity", "Z"), false,
            RPropertyAttributes::Geometry);
    RWipeoutEntity::PropertyBulgeN.generateId(
            RWipeoutEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Vertex"),
            QT_TRANSLATE_NOOP("REntity", "Bulge"), false,
            RPropertyAttributes::Geometry);

    RWipeoutEntity::PropertyBaseAngle.generateId(
            RWipeoutEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Size"),
            QT_TRANSLATE_NOOP("REntity", "Base Angle"));
    RWipeoutEntity::PropertySize1.generateId(
            RWipeoutEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Size"),
            QT_TRANSLATE_NOOP("REntity", "Size 1"));
    RWipeoutEntity::PropertySize2.generateId(
            RWipeoutEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Size"),
            QT_TRANSLATE_NOOP("REntity", "Size 2"));

    RWipeoutEntity::PropertyFrame.generateId(
            RWipeoutEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Frame"));
}
                                 ...
                                 RTransaction *transaction)
{
    ...
    ret = ret || RObject::setMember(data.showFrame, value,
                                    PropertyFrame == propertyTypeId);

    return ret;
}

QPair<QVariant, RPropertyAttributes>
RWipeoutEntity::getProperty(RPropertyTypeId &propertyTypeId, bool humanReadable,
