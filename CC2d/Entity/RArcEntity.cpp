...
void RArcEntity::init()
{
    ...
    RArcEntity::PropertyWorkingSet.generateId(RArcEntity::getRtti(),
                                              RObject::PropertyWorkingSet);
    RArcEntity::PropertyType.generateId(RArcEntity::getRtti(),
                                        REntity::PropertyType);
    RArcEntity::PropertyBlock.generateId(RArcEntity::getRtti(),
                                         REntity::PropertyBlock);
    RArcEntity::PropertyLayer.generateId(RArcEntity::getRtti(),
                                         REntity::PropertyLayer);
    RArcEntity::PropertyLinetype.generateId(RArcEntity::getRtti(),
                                            REntity::PropertyLinetype);
    RArcEntity::PropertyLinetypeScale.generateId(
            RArcEntity::getRtti(), REntity::PropertyLinetypeScale);
    RArcEntity::PropertyLineweight.generateId(RArcEntity::getRtti(),
                                              REntity::PropertyLineweight);
    RArcEntity::PropertyColor.generateId(RArcEntity::getRtti(),
                                         REntity::PropertyColor);
    RArcEntity::PropertyDisplayedColor.generateId(
            RArcEntity::getRtti(), REntity::PropertyDisplayedColor);
    RArcEntity::PropertyDrawOrder.generateId(RArcEntity::getRtti(),
                                             REntity::PropertyDrawOrder);

    RArcEntity::PropertyCenterX.generateId(
            RArcEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Center"),
            QT_TRANSLATE_NOOP("REntity", "X"), false,
            RPropertyAttributes::Geometry);
    RArcEntity::PropertyCenterY.generateId(
            RArcEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Center"),
            QT_TRANSLATE_NOOP("REntity", "Y"), false,
            RPropertyAttributes::Geometry);
    RArcEntity::PropertyCenterZ.generateId(
            RArcEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Center"),
            QT_TRANSLATE_NOOP("REntity", "Z"), false,
            RPropertyAttributes::Geometry);
    RArcEntity::PropertyMiddlePointX.generateId(
            RArcEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Middle"),
            QT_TRANSLATE_NOOP("REntity", "X"), false,
            RPropertyAttributes::Geometry);
    RArcEntity::PropertyMiddlePointY.generateId(
            RArcEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Middle"),
            QT_TRANSLATE_NOOP("REntity", "Y"), false,
            RPropertyAttributes::Geometry);
    RArcEntity::PropertyMiddlePointZ.generateId(
            RArcEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Middle"),
            QT_TRANSLATE_NOOP("REntity", "Z"), false,
            RPropertyAttributes::Geometry);
    RArcEntity::PropertyRadius.generateId(
            RArcEntity::getRtti(), "", QT_TRANSLATE_NOOP("REntity", "Radius"),
            false, RPropertyAttributes::Geometry);
    RArcEntity::PropertyStartAngle.generateId(
            RArcEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Start Angle"), false,
            RPropertyAttributes::Geometry);
    RArcEntity::PropertyEndAngle.generateId(
            RArcEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "End Angle"), false,
            RPropertyAttributes::Geometry);
    RArcEntity::PropertyReversed.generateId(
            RArcEntity::getRtti(), "", QT_TRANSLATE_NOOP("REntity", "Reversed"),
            false, RPropertyAttributes::Geometry);

    RArcEntity::PropertyDiameter.generateId(
            RArcEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Diameter"));
    RArcEntity::PropertyLength.generateId(
            RArcEntity::getRtti(), "", QT_TRANSLATE_NOOP("REntity", "Length"));
    RArcEntity::PropertyTotalLength.generateId(
            RArcEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Total Length"));
    RArcEntity::PropertySweepAngle.generateId(
            RArcEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Sweep Angle"));
    RArcEntity::PropertyArea.generateId(RArcEntity::getRtti(), "",
                                        QT_TRANSLATE_NOOP("REntity", "Area"));
    RArcEntity::PropertyTotalArea.generateId(
            RArcEntity::getRtti(), "",
                             ...
                             const QVariant &value, RTransaction *transaction)
{
    ...
    ret = ret || RObject::setMember(data.radius, value,
                                    PropertyRadius == propertyTypeId);
    ret = ret || RObject::setMember(data.startAngle,
                                    RMath::getNormalizedAngle(value.toDouble()),
                                    PropertyStartAngle == propertyTypeId);
    ret = ret || RObject::setMember(data.endAngle,
                                    RMath::getNormalizedAngle(value.toDouble()),
                                    PropertyEndAngle == propertyTypeId);
...
RArcEntity::getProperty(RPropertyTypeId &propertyTypeId, bool humanReadable,
                        bool noAttributes, bool showOnRequest)
{
    ...
    {
        return qMakePair(
                QVariant(data.getMiddlePoint().z),
                RPropertyAttributes(RPropertyAttributes::Redundant |
                                    RPropertyAttributes::ReadOnly |
                                    RPropertyAttributes::CustomApp001));
    }
    ...
    {
        return qMakePair(QVariant(data.getDiameter()),
                         RPropertyAttributes(RPropertyAttributes::Redundant));
    }
    else if (propertyTypeId == PropertyLength)
    {
    ...
    {
        return qMakePair(QVariant(data.getSweep()),
                         RPropertyAttributes(RPropertyAttributes::Redundant |
                                             RPropertyAttributes::Angle));
    }
    else if (propertyTypeId == PropertyArea)
    {
        return qMakePair(QVariant(data.getArea()),
                         RPropertyAttributes(RPropertyAttributes::Redundant |
    ...
    else if (propertyTypeId == PropertyTotalArea)
    {
        ...
        else
        {
            ...
            v.setValue(0.0);
            return qMakePair(
                    v, RPropertyAttributes(RPropertyAttributes::OnRequest |
                                           RPropertyAttributes::Area));
        }
    }
...
QSharedPointer<REntity> RArcEntity::scaleNonUniform(const RVector &scaleFactors,
                                                    const RVector &center)
{
    return scaleNonUniform(*this, scaleFactors, center);
}

QSharedPointer<REntity> RArcEntity::scaleNonUniform(REntity &entity,
                                                    ...
                                                    const RVector &center)
{
    ...
    if (shapeT.isNull()) { return QSharedPointer<REntity>(); }

    if (RShape::isEllipseShape(*shapeT))
    {
        QSharedPointer<REllipse> ellipseT = shapeT.dynamicCast<REllipse>();
        if (ellipseT.isNull()) { return QSharedPointer<REntity>(); }
        REllipseEntity *e = new REllipseEntity(entity.getDocument(),
                                               REllipseData(*ellipseT));
    ...
    else if (RShape::isArcShape(*shapeT))
    {
        ...
        if (arcT.isNull()) { return QSharedPointer<REntity>(); }
        RArcEntity *arcEntity = dynamic_cast<RArcEntity *>(&entity);
        if (arcEntity == NULL) { return QSharedPointer<REntity>(); }
    ...
    else if (RShape::isCircleShape(*shapeT))
    {
        ...
        if (circleT.isNull()) { return QSharedPointer<REntity>(); }
        RCircleEntity *e =
                new RCircleEntity(entity.getDocument(), RCircleData(*circleT));
        e->copyAttributesFrom(entity.getData());
        return QSharedPointer<REntity>(e);
    }
