...
void RPolylineEntity::init()
{
    ...
    RPolylineEntity::PropertyWorkingSet.generateId(RPolylineEntity::getRtti(),
                                                   RObject::PropertyWorkingSet);
    RPolylineEntity::PropertyType.generateId(RPolylineEntity::getRtti(),
                                             REntity::PropertyType);
    RPolylineEntity::PropertyBlock.generateId(RPolylineEntity::getRtti(),
                                              REntity::PropertyBlock);
    RPolylineEntity::PropertyLayer.generateId(RPolylineEntity::getRtti(),
                                              REntity::PropertyLayer);
    RPolylineEntity::PropertyLinetype.generateId(RPolylineEntity::getRtti(),
                                                 REntity::PropertyLinetype);
    RPolylineEntity::PropertyLinetypeScale.generateId(
            RPolylineEntity::getRtti(), REntity::PropertyLinetypeScale);
    RPolylineEntity::PropertyLineweight.generateId(RPolylineEntity::getRtti(),
                                                   REntity::PropertyLineweight);
    RPolylineEntity::PropertyColor.generateId(RPolylineEntity::getRtti(),
                                              REntity::PropertyColor);
    RPolylineEntity::PropertyDisplayedColor.generateId(
            RPolylineEntity::getRtti(), REntity::PropertyDisplayedColor);
    RPolylineEntity::PropertyDrawOrder.generateId(RPolylineEntity::getRtti(),
                                                  REntity::PropertyDrawOrder);

    RPolylineEntity::PropertyPolylineGen.generateId(
            RPolylineEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Polyline Pattern"));
    RPolylineEntity::PropertyClosed.generateId(
            RPolylineEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Closed"));
    RPolylineEntity::PropertyVertexNX.generateId(
            RPolylineEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Vertex"),
            QT_TRANSLATE_NOOP("REntity", "X"), false,
            RPropertyAttributes::Geometry);
    RPolylineEntity::PropertyVertexNY.generateId(
            RPolylineEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Vertex"),
            QT_TRANSLATE_NOOP("REntity", "Y"), false,
            RPropertyAttributes::Geometry);
    RPolylineEntity::PropertyVertexNZ.generateId(
            RPolylineEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Vertex"),
            QT_TRANSLATE_NOOP("REntity", "Z"), false,
            RPropertyAttributes::Geometry);
    RPolylineEntity::PropertyBulgeN.generateId(
            RPolylineEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Vertex"),
            QT_TRANSLATE_NOOP("REntity", "Bulge"), false,
            RPropertyAttributes::Geometry);
    RPolylineEntity::PropertyAngleN.generateId(
            RPolylineEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Vertex"),
            QT_TRANSLATE_NOOP("REntity", "Angle"));

    RPolylineEntity::PropertyStartWidthN.generateId(
            RPolylineEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Vertex"),
            QT_TRANSLATE_NOOP("REntity", "Start Width"));
    RPolylineEntity::PropertyEndWidthN.generateId(
            RPolylineEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Vertex"),
            QT_TRANSLATE_NOOP("REntity", "End Width"));

    RPolylineEntity::PropertyGlobalWidth.generateId(
            RPolylineEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Global Width"));

    RPolylineEntity::PropertyOrientation.generateId(
            RPolylineEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Orientation"));
    RPolylineEntity::PropertyLength.generateId(
            RPolylineEntity::getRtti(), "",
    ...
    RPolylineEntity::PropertyBaseAngle.generateId(
            ...
            QT_TRANSLATE_NOOP("REntity", "Base Angle"));
    RPolylineEntity::PropertySize1.generateId(
            RPolylineEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Size"),
            QT_TRANSLATE_NOOP("REntity", "Size 1"));
    RPolylineEntity::PropertySize2.generateId(
            RPolylineEntity::getRtti(), QT_TRANSLATE_NOOP("REntity", "Size"),
            QT_TRANSLATE_NOOP("REntity", "Size 2"));

    RPolylineEntity::PropertyElevation.generateId(
            RPolylineEntity::getRtti(), "",
            QT_TRANSLATE_NOOP("REntity", "Global Z"));
}
                                  ...
                                  RTransaction *transaction)
{
    ...
    ret = ret || RObject::setMember(data.polylineGen, value,
                                    PropertyPolylineGen == propertyTypeId);
    ret = ret || RObject::setMember(data.closed, value,
                                    PropertyClosed == propertyTypeId);
    ...
    ret = ret || RObject::setMember(data.bulges, value,
                                    PropertyBulgeN == propertyTypeId);

    if (RPolyline::hasProxy())
    {
        ret = ret || RObject::setMember(data.startWidths, value,
                                        PropertyStartWidthN == propertyTypeId);
        ret = ret || RObject::setMember(data.endWidths, value,
                                        PropertyEndWidthN == propertyTypeId);
...
RPolylineEntity::getProperty(RPropertyTypeId &propertyTypeId,
                             ...
                             bool showOnRequest)
{
    ...
    else if (RPolyline::hasProxy() && propertyTypeId == PropertyGlobalWidth)
    {
        ...
        double val = -1.0;
        for (int i = 0;
             i < data.startWidths.length() && i < data.endWidths.length(); i++)
        {
            if (val < 0.0)
            {
