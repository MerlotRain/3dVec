...
public:
    RAttributeDefinitionEntity(RDocument *document,
                               const RAttributeDefinitionData &data);
    virtual ~RAttributeDefinitionEntity();

    static void init();

    static RS::EntityType getRtti() { return RS::EntityAttributeDefinition; }
    ...
    virtual RAttributeDefinitionData &getData() { return data; }

    virtual const RAttributeDefinitionData &getData() const { return data; }

    void setData(RAttributeDefinitionData &d) { data = d; }
    ...
    QString getTag() const { return data.getTag(); }

    void setTag(const QString &t) { data.setTag(t); }

    QString getPrompt() const { return data.getPrompt(); }

    void setPrompt(const QString &p) { data.setPrompt(p); }

    bool isInvisible() const { return data.isInvisible(); }

    void setInvisible(bool i) { data.setInvisible(i); }
