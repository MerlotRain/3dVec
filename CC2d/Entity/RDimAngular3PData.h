...
public:
    RDimAngular3PData();
    RDimAngular3PData(const RDimensionData &dimData, const RVector &center,
                      const RVector &extensionLine1End,
                      const RVector &extensionLine2End);

    virtual RS::EntityType getType() const { return RS::EntityDimAngular3P; }
    ...
    bool getAngles(double &ang1, double &ang2, bool &reversed, RVector &p1,
                   RVector &p2) const;
