...
public:
    ...
    static RS::EntityType getRtti() { return RS::EntityDimAligned; }
    ...
    virtual RDimAlignedData &getData() { return data; }

    void setData(RDimAlignedData &d) { data = d; }

    virtual const RDimAlignedData &getData() const { return data; }
