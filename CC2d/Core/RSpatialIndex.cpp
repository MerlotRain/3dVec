...
void RSpatialIndex::addToIndex(int id, const QList<RBox> &bbs)
{
    ...
    {
        addToIndex(id, pos, bbs[pos]);
    }
}

void RSpatialIndex::addToIndex(int id, int pos, const RBox &bb)
{
    addToIndex(id, pos, bb.c1.x, bb.c1.y, bb.c1.z, bb.c2.x, bb.c2.y, bb.c2.z);
}

bool RSpatialIndex::removeFromIndex(int id, int pos, const RBox &bb)
{
    return removeFromIndex(id, pos, bb.c1.x, bb.c1.y, bb.c1.z, bb.c2.x, bb.c2.y,
                           bb.c2.z);
}
...
QMap<int, QSet<int>>
RSpatialIndex::queryIntersected(const RBox &b,
                                RSpatialIndexVisitor *dataVisitor)
{

    return queryIntersected(b.c1.x, b.c1.y, b.c1.z, b.c2.x, b.c2.y, b.c2.z,
                            dataVisitor);
}

QMap<int, QSet<int>>
RSpatialIndex::queryContained(const RBox &b, RSpatialIndexVisitor *dataVisitor)
{

    return queryContained(b.c1.x, b.c1.y, b.c1.z, b.c2.x, b.c2.y, b.c2.z,
                          dataVisitor);
}

QList<int> RSpatialIndex::queryContainedIds(double x1, double y1, double z1,
                                            double x2, double y2, double z2,
                                            RSpatialIndexVisitor *dataVisitor)
{

    QMap<int, QSet<int>> res =
            queryContained(x1, y1, z1, x2, y2, z2, dataVisitor);
    return res.keys();
}
 ...
 */
QPair<int, int> RSpatialIndex::queryNearestNeighbor(double x, double y,
                                                    double z)
{
    ...
    return QPair<int, int>(keys.at(0),
                           RS::toList<int>(res[keys.at(0)]).first());
}