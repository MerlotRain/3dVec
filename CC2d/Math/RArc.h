 ...
 * \hasStreamOperator
 */
class CC2DCORE_EXPORT RArc : public RShape
{
public:
    RArc();
    ...
    virtual RShape::Type getShapeType() const { return Arc; }

    virtual RArc *clone() const { return new RArc(*this); }
    ...
    static QList<RArc> createBiarc(const RVector &startPoint,
