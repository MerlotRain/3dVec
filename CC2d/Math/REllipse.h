 ...
 * \hasStreamOperator
 */
class CC2DCORE_EXPORT REllipse : public RShape
{
public:
    REllipse();
    ...
    virtual RShape::Type getShapeType() const { return Ellipse; }

    virtual REllipse *clone() const { return nullptr; }
    ...
    bool isAngleWithinArc(double a) const
    {
        ...
        return RMath::isAngleBetween(a, getStartAngle(), getEndAngle(),
                                     reversed);
    }
    bool isParamWithinArc(double a) const
    {
        if (isFullEllipse()) { return true; }
        return RMath::isAngleBetween(a, getStartParam(), getEndParam(),
                                     reversed);
    }
    ...
    static bool hasProxy() { return ellipseProxy != NULL; }
    ...
    {
        if (ellipseProxy != NULL) { delete ellipseProxy; }
        ellipseProxy = p;
    }
     ...
     * \nonscriptable
     */
    static REllipseProxy *getEllipseProxy() { return ellipseProxy; }
