 ...
 * \hasStreamOperator
 */
class CC2DCORE_EXPORT RXLine : public RShape
{
public:
    RXLine();
    ...
    virtual RShape::Type getShapeType() const { return XLine; }
    ...
    virtual RXLine *clone() const { return new RXLine(*this); }
